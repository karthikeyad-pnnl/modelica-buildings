...
model Guideline36_DRInput
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput uCooDemLimLev
    ...
    annotation (Placement(transformation(extent={{-420,120},{-380,160}}),
        iconTransformation(extent={{-280,60},{-200,140}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput uHeaDemLimLev
    "Heating demand limit level" annotation (Placement(transformation(extent={{-420,
            60},{-380,100}}), iconTransformation(extent={{-280,-20},{-200,60}})));
  Buildings.Controls.OBC.CDL.Routing.IntegerScalarReplicator intScaRep(nout=5)
    "Replicate cooling demand limit level signal"
    annotation (Placement(transformation(extent={{-300,130},{-280,150}})));
  Buildings.Controls.OBC.CDL.Routing.IntegerScalarReplicator intScaRep1(nout=5)
    "Replicate heating demand limit level signal"
...
equation
  ...
  connect(uCooDemLimLev, intScaRep.u)
    annotation (Line(points={{-400,140},{-362,140},{-362,140},{-302,140}},
                                                     color={255,127,0}));
  connect(uHeaDemLimLev, intScaRep1.u)
    annotation (Line(points={{-400,80},{-318,80},{-318,80},{-258,80}},
                                                   color={255,127,0}));
  connect(intScaRep.y, TZonSet.uCooDemLimLev) annotation (Line(points={{-278,140},
          {-180,140},{-180,188},{-102,188}}, color={255,127,0}));
  connect(intScaRep1.y, TZonSet.uHeaDemLimLev) annotation (Line(points={{-282,80},
