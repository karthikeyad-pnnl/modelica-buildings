...
block ClosedLoopValidation
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeamSystem.Terminal.TerminalController terCon[5](
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeamSystem.System.SystemController sysCon(nPum=1, nVal=5,
    minPumSpe=0.7,
    TiPumSpe=50,
    kBypVal=10e-3,
    TiBypVal=900)
...
equation
  connect(terCon.yReh, chiBeaTesBed.uCAVReh) annotation (Line(points={{32,58},{
          50,58},{50,14},{86,14}}, color={0,0,127}));
  connect(terCon.yChiVal, chiBeaTesBed.uChiWatVal) annotation (Line(points={{32,
          54},{48,54},{48,22},{86,22}}, color={0,0,127}));
  ...
  connect(sysCon.yChiWatPum[1], chiBeaTesBed.uPumSta) annotation (Line(points={
          {32,-56},{54,-56},{54,-6},{86,-6}}, color={255,0,255}));
  connect(sysCon.yPumSpe, chiBeaTesBed.uPumSpe) annotation (Line(points={{32,
          -60},{52,-60},{52,-10},{86,-10}}, color={0,0,127}));
  connect(chiBeaTesBed.yPumSta, sysCon.uPumSta[1]) annotation (Line(points={{
          110,-6},{142,-6},{142,-80},{0,-80},{0,-56},{8,-56}}, color={255,0,255}));
  connect(chiBeaTesBed.dPChiWat, sysCon.dPChiWatLoo) annotation (Line(points={{
          110,-2},{146,-2},{146,-86},{-6,-86},{-6,-60},{8,-60}}, color={0,0,127}));
  connect(chiBeaTesBed.yChiWatVal, sysCon.uValPos) annotation (Line(points={{
          110,14},{140,14},{140,-74},{4,-74},{4,-64},{8,-64}}, color={0,0,127}));
  connect(chiBeaTesBed.yChiWatVal, terCon.uChiVal) annotation (Line(points={{
          110,14},{140,14},{140,80},{0,80},{0,42},{8,42}}, color={0,0,127}));
  connect(sysCon.yBypValPos, chiBeaTesBed.uBypValPos) annotation (Line(points={
          {32,-64},{44,-64},{44,26},{86,26}}, color={0,0,127}));
  connect(DOAScon.supFanStart, chiBeaTesBed.uFanSta) annotation (Line(points={{
          18.2,13.1294},{30,13.1294},{30,10},{86,10}}, color={255,0,255}));
  connect(DOAScon.supFanSpeed, chiBeaTesBed.uFanSpe) annotation (Line(points={{
          18.2,9.74118},{28,9.74118},{28,6},{86,6}}, color={0,0,127}));
  connect(DOAScon.yRHC, chiBeaTesBed.uHeaCoi) annotation (Line(points={{18.2,
          3.17647},{26,3.17647},{26,2},{86,2}}, color={0,0,127}));
  connect(DOAScon.yCC, chiBeaTesBed.uCooCoi) annotation (Line(points={{18.2,
          6.35294},{24,6.35294},{24,-2},{86,-2}}, color={0,0,127}));
  connect(chiBeaTesBed.dPDOASAir, DOAScon.DDSP) annotation (Line(points={{110,6},
          {138,6},{138,-40},{-20,-40},{-20,9.95294},{-6,9.95294}}, color={0,0,
          127}));
  connect(chiBeaTesBed.TDOASDis, DOAScon.saT) annotation (Line(points={{110,-10},
          {132,-10},{132,-30},{-10,-30},{-10,1.90588},{-6,1.90588}}, color={0,0,
          127}));
  ...
  connect(chiBeaTesBed.yFanSta, DOAScon.supFanStatus) annotation (Line(points={
          {110,2},{134,2},{134,38},{-12,38},{-12,12.4941},{-6,12.4941}}, color=
          {255,0,255}));
  connect(chiBeaTesBed.relHumDOASRet, DOAScon.retHum) annotation (Line(points={
          {110,-14},{114,-14},{114,-24},{-16,-24},{-16,7.41176},{-6,7.41176}},
        color={0,0,127}));
  ...
  connect(chiBeaTesBed.TZon, terCon.TZon) annotation (Line(points={{110,26},{
          132,26},{132,72},{4,72},{4,50},{8,50}}, color={0,0,127}));
  connect(chiBeaTesBed.VDisAir_flow, terCon.VDis_flow) annotation (Line(points=
          {{110,22},{136,22},{136,76},{2,76},{2,46},{8,46}}, color={0,0,127}));
