...
block TestBed "Testbed consisting of a 5-zone building model paired with DOAS and chilled water supply system"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput yPumSta "Pump proven on" annotation(
    Placement(visible = true, transformation(origin = {2, 30}, extent = {{580, -140}, {620, -100}}, rotation = 0), iconTransformation(origin = {0, 26}, extent = {{100, -160}, {140, -120}}, rotation = 0)));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput yFanSta "Supply fan proven on" annotation(
    Placement(visible = true, transformation(origin = {-2, 32}, extent = {{580, -70}, {620, -30}}, rotation = 0), iconTransformation(origin = {0, 0}, extent = {{100, -80}, {140, -40}}, rotation = 0)));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput dPChiWat "Measured chilled water differential presure" annotation(
    Placement(visible = true, transformation(origin = {-2, 20}, extent = {{580, -110}, {620, -70}}, rotation = 0), iconTransformation(origin = {0, 14}, extent = {{100, -120}, {140, -80}}, rotation = 0)));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput dPDOASAir "Measured airloop differential presure" annotation(
    Placement(visible = true, transformation(origin = {0, 36}, extent = {{580, -40}, {620, 0}}, rotation = 0), iconTransformation(origin = {0, 8}, extent = {{100, -40}, {140, 0}}, rotation = 0)));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TDOASDis(final unit = "K", displayUnit = "K", final quantity = "ThermodynamicTemperature") "Measured DOAS discharge air temperature" annotation(
    Placement(visible = true, transformation(origin = {0, 28}, extent = {{580, -170}, {620, -130}}, rotation = 0), iconTransformation(origin = {0, 40}, extent = {{100, -200}, {140, -160}}, rotation = 0)));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yChiWatVal[5] "Measured chilled water valve position" annotation(
    Placement(transformation(extent = {{580, 60}, {620, 100}}), iconTransformation(extent = {{100, 40}, {140, 80}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yBypValPos "Measured bypass valve position" annotation(
    Placement(transformation(extent = {{580, 100}, {620, 140}}), iconTransformation(extent = {{100, 80}, {140, 120}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yDamPos[5] "Measured CAV damper position" annotation(
    Placement(visible = true, transformation(origin = {2, 46}, extent = {{580, -10}, {620, 30}}, rotation = 0), iconTransformation(origin = {0, 0}, extent = {{100, 0}, {140, 40}}, rotation = 0)));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput relHumDOASRet "Measured DOAS return air relative humidity" annotation(
    Placement(visible = true, transformation(origin = {2, 28}, extent = {{580, -200}, {620, -160}}, rotation = 0), iconTransformation(origin = {0, 24}, extent = {{100, -240}, {140, -200}}, rotation = 0)));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TZon[5] "Measured zone temperature" annotation(
    Placement(transformation(extent = {{580, 240}, {620, 280}}), iconTransformation(extent = {{100, 160}, {140, 200}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yRelHumZon[5] "Measured zone relative humidity" annotation(
    Placement(transformation(extent = {{580, 280}, {620, 320}}), iconTransformation(extent = {{100, 200}, {140, 240}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VDisAir_flow[5] "Measured zone discharge air volume flow rate" annotation(
    Placement(transformation(extent = {{580, 200}, {620, 240}}), iconTransformation(extent = {{100, 120}, {140, 160}})));
  Buildings.Fluid.Movers.SpeedControlled_y pum(redeclare package Medium = MediumW, redeclare Data.PumpCurve per, final addPowerToMedium = false) "Chilled water pump" annotation(
    Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin = {100, -130})));
  ...
  Buildings.Fluid.Movers.SpeedControlled_y fan(redeclare package Medium = MediumA, redeclare Data.FanCurve per, final addPowerToMedium = false) "DOAS fan" annotation(
  ...
  Buildings.Controls.OBC.CDL.Continuous.Multiply pro1 "Find fan flow signal by multiplying enable signal with speed signal" annotation(
    Placement(visible = true, transformation(origin = {-24, 8}, extent = {{-280, 10}, {-260, 30}}, rotation = 0)));
  ...
  Buildings.Fluid.Sensors.RelativeHumidityTwoPort senRelHum(redeclare package Medium = MediumA, m_flow_nominal = mAirTot_flow_nominal) "Relative humidity sensor" annotation(
    Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 180, origin = {-90, 160})));
  Buildings.Examples.ChilledBeamSystem.BaseClasses.ZoneModel_simplified nor(nConExt = 0, nConExtWin = 0, nConPar = 0, nConBou = 3, nSurBou = 0, datConBou(layers = {conIntWal, conIntWal, conIntWal}, A = {6.47, 40.76, 6.47}*hRoo, til = {Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall}), redeclare package MediumA = MediumA, redeclare package MediumW = MediumW, Q_flow_nominal = QNor_flow_nominal, TRadSup_nominal = TChiWatSup_nominal, TRadRet_nominal = TChiWatRet_nominal, mRad_flow_nominal = mChiWatNor_flow_nominal, V = VRooNor, TAir_nominal = 297.04, mA_flow_nominal = mAirNor_flow_nominal, mAChiBea_flow_nominal = mAChiBeaNor_flow_nominal) "North zone" annotation(
    Placement(transformation(extent = {{180, 300}, {200, 320}})));
  Buildings.Examples.ChilledBeamSystem.BaseClasses.ZoneModel_simplified wes(nConExt = 0, nConExtWin = 0, nConPar = 0, nConBou = 3, nSurBou = 0, datConBou(layers = {conIntWal, conIntWal, conIntWal}, A = {6.47, 40.76, 6.47}*hRoo, til = {Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall}), redeclare package MediumA = MediumA, redeclare package MediumW = MediumW, Q_flow_nominal = QWes_flow_nominal, TRadSup_nominal = TChiWatSup_nominal, TRadRet_nominal = TChiWatRet_nominal, mRad_flow_nominal = mChiWatWes_flow_nominal, V = VRooWes, TAir_nominal = 297.04, mA_flow_nominal = mAirWes_flow_nominal, mAChiBea_flow_nominal = mAChiBeaWes_flow_nominal) "West zone" annotation(
    Placement(transformation(extent = {{120, 240}, {140, 260}})));
  Buildings.Examples.ChilledBeamSystem.BaseClasses.ZoneModel_simplified cor(nConExt = 0, nConExtWin = 0, nConPar = 0, nConBou = 3, nSurBou = 0, datConBou(layers = {conIntWal, conIntWal, conIntWal}, A = {6.47, 40.76, 6.47}*hRoo, til = {Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall}), redeclare package MediumA = MediumA, redeclare package MediumW = MediumW, Q_flow_nominal = QCor_flow_nominal, TRadSup_nominal = TChiWatSup_nominal, TRadRet_nominal = TChiWatRet_nominal, mRad_flow_nominal = mChiWatCor_flow_nominal, V = VRooCor, TAir_nominal = 297.04, mA_flow_nominal = mAirCor_flow_nominal, mAChiBea_flow_nominal = mAChiBeaCor_flow_nominal) "Core zone" annotation(
    Placement(transformation(extent = {{180, 240}, {200, 260}})));
  Buildings.Examples.ChilledBeamSystem.BaseClasses.ZoneModel_simplified eas(nConExt = 0, nConExtWin = 0, nConPar = 0, nConBou = 3, nSurBou = 0, datConBou(layers = {conIntWal, conIntWal, conIntWal}, A = {6.47, 40.76, 6.47}*hRoo, til = {Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall}), redeclare package MediumA = MediumA, redeclare package MediumW = MediumW, Q_flow_nominal = QEas_flow_nominal, TRadSup_nominal = TChiWatSup_nominal, TRadRet_nominal = TChiWatRet_nominal, mRad_flow_nominal = mChiWatEas_flow_nominal, V = VRooEas, TAir_nominal = 297.04, mA_flow_nominal = mAirEas_flow_nominal, mAChiBea_flow_nominal = mAChiBeaEas_flow_nominal) "East zone" annotation(
    Placement(transformation(extent = {{240, 240}, {260, 260}})));
  Buildings.Examples.ChilledBeamSystem.BaseClasses.ZoneModel_simplified sou(nConExt = 0, nConExtWin = 0, nConPar = 0, nConBou = 3, nSurBou = 0, datConBou(layers = {conIntWal, conIntWal, conIntWal}, A = {6.47, 40.76, 6.47}*hRoo, til = {Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall}), redeclare package MediumA = MediumA, redeclare package MediumW = MediumW, Q_flow_nominal = QSou_flow_nominal, TRadSup_nominal = TChiWatSup_nominal, TRadRet_nominal = TChiWatRet_nominal, mRad_flow_nominal = mChiWatSou_flow_nominal, V = VRooSou, TAir_nominal = 297.04, mA_flow_nominal = mAirSou_flow_nominal, mAChiBea_flow_nominal = mAChiBeaSou_flow_nominal) "South zone" annotation(
  ...
  Buildings.Examples.VAVReheat.BaseClasses.VAVReheatBox easCAVTer(redeclare package MediumA = MediumA, redeclare package MediumW = MediumW, VRoo = VRooEas, allowFlowReversal = false) "CAV terminal for east zone" annotation(
  ...
  Buildings.Examples.VAVReheat.BaseClasses.VAVReheatBox norCAVTer(redeclare package MediumA = MediumA, redeclare package MediumW = MediumW, VRoo = VRooNor, allowFlowReversal = false) "CAV terminal for north zone" annotation(
  ...
  Buildings.Examples.VAVReheat.BaseClasses.VAVReheatBox wesCAVTer(redeclare package MediumA = MediumA, redeclare package MediumW = MediumW, VRoo = VRooWes, allowFlowReversal = false) "CAV terminal for west zone" annotation(
  ...
  Buildings.Examples.VAVReheat.BaseClasses.VAVReheatBox corCAVTer(redeclare package MediumA = MediumA, redeclare package MediumW = MediumW, mCooAir_flow_nominal = mAirCor_flow_nominal, mHeaAir_flow_nominal = mAirCor_flow_nominal, VRoo = VRooCor, allowFlowReversal = false) "CAV terminal for core zone" annotation(
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput OutdoorAirTemp "Outdoor Air Dry Bulb Temperature" annotation(
    Placement(visible = true, transformation(origin = {0, -64}, extent = {{580, -200}, {620, -160}}, rotation = 0), iconTransformation(origin = {0, 4}, extent = {{100, -240}, {140, -200}}, rotation = 0)));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput exhFanSta "Exhaust Fan Proven on" annotation(
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{580, -70}, {620, -30}}, rotation = 0), iconTransformation(origin = {0, 18}, extent = {{100, -80}, {140, -40}}, rotation = 0)));
  ...
  Buildings.Fluid.Sensors.RelativePressure relativePressure(redeclare package Medium = MediumA) annotation(
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume vol(redeclare package Medium = MediumA, V = 1.2*100, energyDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, m_flow_nominal = mAirTot_flow_nominal, nPorts = 2) annotation(
    Placement(visible = true, transformation(origin = {-216, 52}, extent = {{6, -16}, {26, 4}}, rotation = 0)));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput rAT annotation(
    Placement(visible = true, transformation(origin = {0, -94}, extent = {{580, -200}, {620, -160}}, rotation = 0), iconTransformation(origin = {0, 4}, extent = {{100, -240}, {140, -200}}, rotation = 0)));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput erwsuphum "ERW supply relative humidity sensor" annotation(
    Placement(visible = true, transformation(origin = {0, -14}, extent = {{580, -200}, {620, -160}}, rotation = 0), iconTransformation(origin = {0, 50}, extent = {{100, -240}, {140, -200}}, rotation = 0)));
  Buildings.Fluid.Sensors.RelativeHumidityTwoPort senRelHum1(redeclare package Medium = MediumA) annotation(
    Placement(visible = true, transformation(origin = {-186, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(jun.port_1, pum.port_b) annotation(
    Line(points = {{100, -50}, {100, -120}}, color = {0, 127, 255}));
  ...
  connect(weaBus, amb.weaBus) annotation(
    Line(points = {{-286, -16}, {-260, -16}, {-260, -29}, {-288, -29}}, color = {255, 204, 51}, thickness = 0.5));
  ...
  connect(souCoo1.ports[1], pum.port_a) annotation(
    Line(points = {{100, -164}, {100, -140}}, color = {0, 127, 255}));
  connect(jun3.port_2, sinCoo1.ports[1]) annotation(
    Line(points = {{250, -50}, {250, -166}, {248, -166}}, color = {0, 127, 255}));
  connect(fan.port_b, senTem.port_a) annotation(
    Line(points = {{-60, 0}, {-40, 0}}, color = {0, 127, 255}));
  connect(cooCoi.port_b2, fan.port_a) annotation(
    Line(points = {{-110, 0}, {-80, 0}}, color = {0, 127, 255}));
  connect(senRelPre.port_a, pum.port_b) annotation(
    Line(points = {{150, -70}, {100, -70}, {100, -120}}, color = {0, 127, 255}));
  connect(senRelPre.port_b, sinCoo1.ports[2]) annotation(
    Line(points = {{170, -70}, {252, -70}, {252, -166}}, color = {0, 127, 255}));
  connect(fan.port_b, senRelPre1.port_a) annotation(
    Line(points = {{-60, 0}, {-50, 0}, {-50, 20}}, color = {0, 127, 255}));
  connect(senRelPre1.port_b, amb.ports[1]) annotation(
    Line(points = {{-50, 40}, {-50, 60}, {-212, 60}, {-212, -2}, {-216, -2}, {-216, -29}, {-266, -29}}, color = {0, 127, 255}));
  connect(pum.y_actual, hys.u) annotation(
    Line(points = {{93, -119}, {93, -110}, {138, -110}}, color = {0, 0, 127}));
  ...
  connect(pro.y, pum.y) annotation(
    Line(points = {{-258, -130}, {88, -130}}, color = {0, 0, 127}));
  ...
  connect(booToRea1.y, pro1.u1) annotation(
    Line(points = {{-306, 38}, {-306, 34}}, color = {0, 0, 127}));
  connect(uFanSpe, pro1.u2) annotation(
    Line(points = {{-360, 10}, {-300, 10}, {-300, 22}, {-306, 22}}, color = {0, 0, 127}));
  connect(pro1.y, fan.y) annotation(
    Line(points = {{-282, 28}, {-72, 28}, {-72, 12}, {-70, 12}}, color = {0, 0, 127}));
  ...
  connect(demux.y[1], val.y) annotation(
    Line(points = {{60, -14.4}, {130, -14.4}, {130, -28}}, color = {0, 0, 127}));
  ...
  connect(uChiWatVal, demux.u) annotation(
    Line(points = {{-360, 180}, {-240, 180}, {-240, 140}, {0, 140}, {0, -20}, {38, -20}}, color = {0, 0, 127}));
  connect(demux.y[2], val1.y) annotation(
    Line(points = {{60, -17.2}, {80, -17.2}, {80, 18}, {130, 18}, {130, 12}}, color = {0, 0, 127}));
  connect(demux.y[3], val3.y) annotation(
    Line(points = {{60, -20}, {80, -20}, {80, 60}, {130, 60}, {130, 52}}, color = {0, 0, 127}));
  connect(demux.y[4], val4.y) annotation(
    Line(points = {{60, -22.8}, {80, -22.8}, {80, 100}, {130, 100}, {130, 92}}, color = {0, 0, 127}));
  connect(demux.y[5], val5.y) annotation(
    Line(points = {{60, -25.6}, {80, -25.6}, {80, 138}, {130, 138}, {130, 132}}, color = {0, 0, 127}));
  ...
  connect(senRelPre1.p_rel, dPDOASAir) annotation(
    Line(points = {{-41, 30}, {4, 30}, {4, -158}, {540, -158}, {540, 16}, {600, 16}}, color = {0, 0, 127}));
  ...
  connect(pre1.y, yFanSta) annotation(
    Line(points = {{-312, 78}, {-36, 78}, {-36, -174}, {50, -174}, {50, -208}, {554, -208}, {554, -18}, {598, -18}}, color = {255, 0, 255}));
  ...
  connect(truDel.y, exhFanSta) annotation(
    Line(points = {{-276, 84}, {-168, 84}, {-168, -50}, {600, -50}}, color = {255, 0, 255}));
  connect(senTem1.port_b, senRelHum.port_b) annotation(
    Line(points = {{-148, 160}, {-100, 160}}, color = {0, 127, 255}));
  connect(amb.ports[2], senTem1.port_a) annotation(
    Line(points = {{-266, -29}, {-216, -29}, {-216, 160}, {-168, 160}}, color = {0, 127, 255}));
  connect(weaBus.TOut, OutdoorAirTemp) annotation(
    Line(points = {{-286, -16}, {-204, -16}, {-204, -244}, {600, -244}}, color = {0, 0, 127}));
  connect(cooCoi.port_a1, souCoo.ports[1]) annotation(
    Line(points = {{-110, -12}, {-100, -12}, {-100, -60}}, color = {0, 127, 255}));
  connect(relativePressure.port_b, amb.ports[3]) annotation(
    Line(points = {{-130, 64}, {-130, -29}, {-266, -29}}, color = {0, 127, 255}));
  connect(eas.portAir_b, relativePressure.port_a) annotation(
    Line(points = {{240, 246}, {240, 44}, {-130, 44}}, color = {0, 127, 255}));
  connect(bldgSP, relativePressure.p_rel) annotation(
    Line(points = {{600, -316}, {600, -288}, {-121, -288}, {-121, 54}}, color = {0, 0, 127}));
  connect(amb.ports[4], senMasFlo.port_a) annotation(
    Line(points = {{-266, -29}, {-266, -8}, {-246, -8}}, color = {0, 127, 255}));
  connect(senMasFlo.port_b, vol.ports[1]) annotation(
    Line(points = {{-226, -8}, {-226, 36}, {-200, 36}}, color = {0, 127, 255}));
  connect(deltaT, gai2.u) annotation(
    Line(points = {{-360, -16}, {-336, -16}, {-336, -2}, {-324, -2}}, color = {0, 0, 127}));
  connect(gai2.y, mul.u1) annotation(
    Line(points = {{-300, -2}, {-276, -2}, {-276, 30}}, color = {0, 0, 127}));
  connect(senMasFlo.m_flow, mul.u2) annotation(
    Line(points = {{-236, 3}, {-276, 3}, {-276, 18}}, color = {0, 0, 127}));
  ...
  connect(senTem1.T, rAT) annotation(
    Line(points = {{-158, 172}, {-28, 172}, {-28, -312}, {470, -312}, {470, -274}, {600, -274}}, color = {0, 0, 127}));
  connect(mul.y, preHea.Q_flow) annotation(
    Line(points = {{-252, 24}, {-252, 34}, {-250, 34}, {-250, 44}}, color = {0, 0, 127}));
  connect(preHea.port, vol.heatPort) annotation(
    Line(points = {{-230, 44}, {-230, 49}, {-210, 49}, {-210, 46}}, color = {191, 0, 0}));
  connect(senRelHum1.phi, erwsuphum) annotation(
    Line(points = {{-186, 19}, {-186, -194}, {600, -194}}, color = {0, 0, 127}));
  connect(vol.ports[2], senRelHum1.port_a) annotation(
    Line(points = {{-200, 36}, {-196, 36}, {-196, 8}}, color = {0, 127, 255}));
  connect(senRelHum1.port_b, heaCoi.port_a2) annotation(
    Line(points = {{-176, 8}, {-174, 8}, {-174, -10}}, color = {0, 127, 255}));
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -240}, {100, 240}}), graphics = {Text(textColor = {0, 0, 255}, extent = {{-140, 280}, {140, 240}}, textString = "%name"), Rectangle(origin = {-1, -5}, lineColor = {0, 0, 127}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-101, -247}, {101, 247}})}),
