...
model SimplifiedRoom_customLoad "Simplified data center room"
  ...
  .Modelica.Blocks.Interfaces.RealOutput TRooAir(unit="K", displayUnit="degC")
    ...
    .Buildings.Controls.OBC.CDL.Interfaces.RealInput uLoad annotation(Placement(transformation(extent = {{-94.0,-50.0},{-54.0,-10.0}},origin = {0.0,0.0},rotation = 0.0)));
equation
  ...
  connect(TAir.T, TRooAir) annotation (Line(points={{60,0},{76,0},{110,0}},
               color={0,0,127}));
    connect(uLoad,QSou.Q_flow) annotation(Line(points = {{-74,-30},{-18,-30}},color = {0,0,127}));
  annotation (
