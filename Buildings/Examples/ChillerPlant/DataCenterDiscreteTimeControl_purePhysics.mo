...
model DataCenterDiscreteTimeControl_purePhysics
  "Model of data center with trim and respond control"
  extends .Buildings.Examples.ChillerPlant.BaseClasses.DataCenter_purePhysics(TAirSet(k=
          273.15 + 14));
...
end DataCenterDiscreteTimeControl_purePhysics;
