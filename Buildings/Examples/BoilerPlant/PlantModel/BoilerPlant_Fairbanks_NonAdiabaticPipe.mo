...
model BoilerPlant_Fairbanks_NonAdiabaticPipe
  ...
  Buildings.Fluid.Movers.SpeedControlled_y pum(
    ...
    redeclare Fluid.Movers.Data.Pumps.Wilo.customPumpCurves_Fairbanks per,
...
end BoilerPlant_Fairbanks_NonAdiabaticPipe;
