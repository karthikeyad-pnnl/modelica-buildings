...
block singledMPump_scenario7
  ...
  Buildings.Examples.BoilerPlant.PlantModel.BoilerPlant_Buffalo_NonAdiabaticPipe_singlePump_splitterPressure boiPla
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con6(k=75000)
