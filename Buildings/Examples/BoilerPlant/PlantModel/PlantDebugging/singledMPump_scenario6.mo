...
equation
  ...
  connect(zoneModel_simplified.y, conPID.u_m) annotation (Line(points={{42,50},
  ...
  connect(con5.y, boiPla.uBypValSig) annotation (Line(points={{-58,-70},{-48,
          -70},{-48,-13},{18,-13}}, color={0,0,127}));
  connect(conPID.y, greThr.u) annotation (Line(points={{-18,80},{-12,80},{-12,
          90},{8,90}}, color={0,0,127}));
  connect(greThr.y, booToRea.u)
    annotation (Line(points={{32,90},{48,90}}, color={255,0,255}));
  connect(booToRea.y, pro.u1)
    annotation (Line(points={{72,90},{78,90}}, color={0,0,127}));
  connect(conPID.y, pro.u2) annotation (Line(points={{-18,80},{-12,80},{-12,78},
          {78,78}}, color={0,0,127}));
  connect(pro.y, val3.y) annotation (Line(points={{102,84},{120,84},{120,36},{0,
          36},{0,20},{12,20}}, color={0,0,127}));
