...
block singledMPump_scenario3
  ...
  Controls.OBC.CDL.Logical.Sources.Pulse booPul(period=600)
...
equation
  ...
  connect(sin.y, boiPla.uPumSpe) annotation (Line(points={{-58,-50},{-50,-50},{
          -50,-46},{-4,-46},{-4,-10},{18,-10}}, color={0,0,127}));
