...
model BoilerPlant_legacy "Boiler plant model for closed loop testing"
...
//------------------------------------------------------------------------------//
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uBoiSta[2] "Boiler status signal" annotation (
      Placement(transformation(extent={{-440,-30},{-400,10}}),
        iconTransformation(extent={{-140,40},{-100,80}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uHotIsoVal[2] "Hot water isolation valve signal"
    annotation (Placement(transformation(extent={{-440,-70},{-400,-30}}),
        iconTransformation(extent={{-140,10},{-100,50}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uPumSpe[2] "Pump speed signal" annotation (Placement(
        transformation(extent={{-440,-150},{-400,-110}}), iconTransformation(
          extent={{-140,-50},{-100,-10}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uPumSta[2] "Pump status signal" annotation (
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal booToRea1[2] "Boolean to Real conversion"
    annotation (Placement(transformation(extent={{-380,-20},{-360,0}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput QRooInt_flowrate "Room internal load flowrate"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uRadIsoVal "Radiator isolation valve signal"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yHotWatDp[1](final unit="Pa", displayUnit="Pa")
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TOutAir(
    ...
    annotation (Placement(transformation(extent={{-440,-230},{-400,-190}}),
        iconTransformation(extent={{-140,70},{-100,110}}, rotation=90)));
...
equation
  ...
  connect(pro[1].y, val4.y) annotation (Line(points={{-298,-110},{-180,-110},{
          -180,-90},{-150,-90},{-150,-98}}, color={0,0,127}));
  connect(pro[2].y, val5.y) annotation (Line(points={{-298,-110},{-180,-110},{
          -180,-148},{-100,-148},{-100,-170},{-94,-170},{-94,-120},{-70,-120},{
