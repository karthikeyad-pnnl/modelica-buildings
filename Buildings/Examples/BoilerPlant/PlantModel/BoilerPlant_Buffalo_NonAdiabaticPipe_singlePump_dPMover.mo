...
model BoilerPlant_Buffalo_NonAdiabaticPipe_singlePump_dPMover
  ...
  Buildings.Controls.OBC.CDL.Logical.Timer tim1(t=60)
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueDelay truDel[2](delayTime=fill(60, 2))
                                                             "True delay"
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con(k=100000)
...
equation
  ...
  connect(con1.y, val2.y) annotation (Line(points={{-38,-100},{10,-100},{10,-138}},
        color={0,0,127}));
  connect(con1.y, val1.y) annotation (Line(points={{-38,-100},{-10,-100},{-10,-180},
  ...
  connect(con.y, pro.u2) annotation (Line(points={{-78,130},{-70,130},{-70,80},
          {-170,80},{-170,-30},{-220,-30},{-220,-16},{-212,-16}}, color={0,0,
          127}));
  connect(con.y, pum.dp_in) annotation (Line(points={{-78,130},{-70,130},{-70,
          80},{-100,80},{-100,-70},{-42,-70}}, color={0,0,127}));
...
end BoilerPlant_Buffalo_NonAdiabaticPipe_singlePump_dPMover;
