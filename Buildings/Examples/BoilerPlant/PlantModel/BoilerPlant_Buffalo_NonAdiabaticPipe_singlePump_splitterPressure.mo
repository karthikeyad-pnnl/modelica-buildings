...
model BoilerPlant_Buffalo_NonAdiabaticPipe_singlePump_splitterPressure
  ...
  Buildings.Fluid.FixedResistances.Junction spl1(
    ...
    final dp_nominal={dpFixed_nominal_value,0,dpFixed_nominal_value})
    "Splitter"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
      rotation=90,
      origin={-30,-150})));
  ...
  Buildings.Fluid.FixedResistances.Junction spl4(
    ...
    final dp_nominal={dpFixed_nominal_value,0,0})
    "Splitter"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
      rotation=90,
      origin={-30,40})));
  ...
  Fluid.FixedResistances.Junction           spl6(
    ...
    final m_flow_nominal={-mBoi_flow_nominal1,mRad_flow_nominal,-
        mBoi_flow_nominal2},
    final dp_nominal={0,dpFixed_nominal_value,0})
    "Splitter"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
      rotation=0,
      origin={150,-150})));
  ...
  Buildings.Controls.OBC.CDL.Reals.Gain gai(k=mRad_flow_nominal)
    annotation (Placement(transformation(extent={{-114,-20},{-94,0}})));
  Buildings.Controls.OBC.CDL.Reals.Gain gai1(k=1/mRad_flow_nominal)
...
equation
  ...
  connect(con1.y, val1.y) annotation (Line(points={{-74,-90},{-10,-90},{-10,
...
end BoilerPlant_Buffalo_NonAdiabaticPipe_singlePump_splitterPressure;
