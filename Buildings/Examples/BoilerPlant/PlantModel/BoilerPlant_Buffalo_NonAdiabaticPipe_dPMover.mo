...
model BoilerPlant_Buffalo_NonAdiabaticPipe_dPMover
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayLinear           val5(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
      rotation=90,
        origin={10,-70})));
  Buildings.Controls.OBC.CDL.Reals.Hysteresis hys[2](uLow=fill(0.5, 2), uHigh=fill(
  ...
  Buildings.Controls.OBC.CDL.Reals.Hysteresis hys2[2](uLow=fill(0.09, 2), uHigh=fill(
        0.1, 2))
            "Check if pumps are on"
    annotation (Placement(transformation(extent={{100,-20},{120,0}})));
  Buildings.Controls.OBC.CDL.Logical.Timer tim1[2](t=fill(60, 2))
    "Check time for which pump status is on"
    annotation (Placement(transformation(extent={{140,-20},{160,0}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput yPumSta[2] "Pump status signal"
  ...
  Buildings.Controls.OBC.CDL.Logical.Latch lat[2]
  ...
  Buildings.Controls.OBC.CDL.Logical.Pre pre[2] "Logical pre block"
    annotation (Placement(transformation(extent={{240,-140},{260,-120}})));
  Buildings.Controls.OBC.CDL.Reals.Hysteresis hys3[2](uLow=fill(0.9, 2), uHigh=fill(
        0.95, 2))                "Check for flow through boiler"
    annotation (Placement(transformation(extent={{120,-60},{140,-40}})));
  Buildings.Controls.OBC.CDL.Reals.Add add2[2](k1=fill(-1, 2))
  ...
  Fluid.FixedResistances.Junction           spl6(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
      rotation=0,
      origin={150,-150})));
  Buildings.Controls.OBC.CDL.Reals.GreaterThreshold greThr[2](h=0.3)
  ...
  Buildings.Controls.OBC.CDL.Reals.GreaterThreshold greThr1[2](t=fill(0, 2))
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueDelay truDel[2](delayTime=60) "True delay"
  ...
  Buildings.Controls.OBC.CDL.Reals.GreaterThreshold greThr2[2](t=273.15 + 95)
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con(k=4000) "Required pump dP"
  ...
  Buildings.Controls.OBC.CDL.Reals.Gain gai(k=95000)
    annotation (Placement(transformation(extent={{-80,120},{-60,140}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con1(k=100000)
    "Required pump dP"
...
equation
  ...
  connect(reaRep1.y, pro.u2) annotation (Line(points={{-240,-20},{-220,-20},{
          -220,-16},{-212,-16}}, color={0,0,127}));
  connect(pro[1].y, pum.dp_in) annotation (Line(points={{-188,-10},{-92,-10},{
          -92,-40},{-82,-40}}, color={0,0,127}));
  connect(con.y, conPID1.u_s)
    annotation (Line(points={{-148,130},{-122,130}}, color={0,0,127}));
  connect(senRelPre.p_rel, conPID1.u_m) annotation (Line(points={{90,71},{90,66},
          {-110,66},{-110,118}}, color={0,0,127}));
  connect(conPID1.y, gai.u)
    annotation (Line(points={{-98,130},{-82,130}}, color={0,0,127}));
  connect(con1.y, reaRep1.u) annotation (Line(points={{-98,170},{-48,170},{-48,
          80},{-140,80},{-140,-34},{-280,-34},{-280,-20},{-264,-20}}, color={0,
          0,127}));
  connect(uBypValSig, val.y) annotation (Line(points={{-340,-40},{-120,-40},{
          -120,60},{90,60},{90,52}}, color={0,0,127}));
  connect(pro[2].y, pum1.dp_in) annotation (Line(points={{-188,-10},{-40,-10},{
          -40,-40},{-2,-40}}, color={0,0,127}));
  connect(booToRea[2].y, val5.y) annotation (Line(points={{-198,40},{-100,40},{
          -100,-58},{-20,-58},{-20,-70},{-2,-70}}, color={0,0,127}));
...
end BoilerPlant_Buffalo_NonAdiabaticPipe_dPMover;
