...
model ClosedLoopTest_baseline_OAReset "Closed loop testing model"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Controller_baseline_OAReset controller(
...
equation
  ...
  connect(controller.TBoiHotWatSupSet, boilerPlant.TBoiHotWatSupSet)
    annotation (Line(points={{-18,10},{-2,10},{-2,-12},{40,-12}},     color={0,0,
          127}));
  connect(controller.yPriPumSpe, uniDel.u) annotation (Line(points={{-18,-6},{
          -10,-6},{-10,-30},{-2,-30}}, color={0,0,127}));
  connect(uniDel.y, reaRep.u)
    annotation (Line(points={{22,-30},{28,-30}}, color={0,0,127}));
  connect(reaRep.y, controller.uPriPumSpe) annotation (Line(points={{52,-30},{
          60,-30},{60,-50},{-60,-50},{-60,-32},{-42,-32}}, color={0,0,127}));
...
end ClosedLoopTest_baseline_OAReset;
