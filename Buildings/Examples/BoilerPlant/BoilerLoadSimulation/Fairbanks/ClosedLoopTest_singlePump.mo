...
block ClosedLoopTest_singlePump
  ...
  PlantModel.ZoneModel_simplified zoneModel_simplified(
    Q_flow_nominal=6517729.96,
    TRadSup_nominal=333.15,
    TRadRet_nominal=323.15,
    mRad_flow_nominal=144.001,
    V=126016.35,
  ...
  Buildings.Examples.BoilerPlant.PlantModel.BoilerPlant_Fairbanks_NonAdiabaticPipe_singlePump boiPla(
  ...
  Buildings.Controls.OBC.CDL.Reals.Hysteresis hys1(uLow=0.5, uHigh=0.55)
  ...
  Buildings.Controls.OBC.CDL.Reals.Limiter lim(uMax=1, uMin=0.5)
