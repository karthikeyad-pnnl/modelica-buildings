...
block ClosedLoopTest_baseline "Model to test step response of zone model"
  ...
  parameter Modelica.Units.SI.MassFlowRate mRad_flow_nominal=95.784
  ...
  Buildings.Examples.BoilerPlant.PlantModel.BoilerPlant_Atlanta_NonAdiabaticPipe boiPla(
  ...
  BoundaryConditions.WeatherData.ReaderTMY3           weaDat(final filNam=
        ModelicaServices.ExternalReferences.loadResource("modelica://Buildings/Resources/weatherdata/USA_GA_Atlanta-Hartsfield.Jackson.Intl.AP.722190_TMY3.mos"))
    "Weather data reader"
