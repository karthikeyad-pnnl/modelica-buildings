...
model Guideline36_BoilerPlant_Testing
  ...
  Fluid.FixedResistances.Pipe pip(
    ...
    thicknessIns=0.01,
    lambdaIns=100,
    length=100) annotation (Placement(transformation(extent={{-10,-10},{10,10}}, rotation=180,
        origin={0,80})));
  Fluid.FixedResistances.Junction jun(
    redeclare package Medium = MediumW,
    m_flow_nominal={113,-113,113},
    dp_nominal={0,0,0})
...
equation
  connect(jun.port_3, pip.port_a) annotation (Line(points={{30,-30},{50,-30},{50,
          80},{10,80}}, color={0,127,255}));
  connect(pip.port_b, jun1.port_3) annotation (Line(points={{-10,80},{-40,80},{
          -40,-30},{-30,-30}},
                           color={0,127,255}));
  connect(guideline36_modified.port_b, jun1.port_1) annotation (Line(points={{-2,40},
          {-2,20},{-20,20},{-20,-20}},     color={0,127,255}));
  connect(jun.port_2, guideline36_modified.port_a) annotation (Line(points={{20,
          -20},{20,20},{2,20},{2,40}}, color={0,127,255}));
  ...
  connect(boiPla.port_a, jun1.port_2) annotation (Line(points={{6,-100},{6,-44},
          {-20,-44},{-20,-40}}, color={0,127,255}));
  connect(boiPla.port_b, jun.port_1) annotation (Line(points={{-6,-100},{-6,-48},
          {20,-48},{20,-40}}, color={0,127,255}));
...
end Guideline36_BoilerPlant_Testing;
