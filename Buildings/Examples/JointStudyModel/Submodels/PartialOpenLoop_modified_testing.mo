...
partial model PartialOpenLoop_modified_testing
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  VAVReheat.ThermalZones.Floor flo(
...
public
  ...
  Fluid.Actuators.Valves.TwoWayLinear val(
    redeclare package Medium = MediumW,
    m_flow_nominal=m_flow_nominal*1000*(10 - (-20))/4200/10,
...
equation
  ...
  connect(cooCoi.port_a1, souCoo.ports[1]) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(gaiCooCoi.y, souCoo.m_flow_in) annotation (Line(points={{202,-170},{222,
          -170},{222,-132}},     color={0,0,127}));
  ...
  connect(heaCoi.port_b2, cooCoi.port_a2) annotation (Line(
      ...
      color={0,127,255},
      thickness=0.5));
  connect(sinHea.ports[1], heaCoi.port_b1) annotation (Line(points={{70,-120},{
          72,-120},{72,-52},{98,-52}}, color={0,127,255}));
  connect(gaiHeaCoi.y, souHea.m_flow_in) annotation (Line(points={{102,-250},{
          122,-250},{122,-222}}, color={0,0,127}));
  connect(souHea.ports[1], val.port_a)
    annotation (Line(points={{130,-200},{130,-160}}, color={0,127,255}));
  connect(val.port_b, heaCoi.port_a1) annotation (Line(points={{130,-140},{130,
          -52},{118,-52}}, color={0,127,255}));
...
end PartialOpenLoop_modified_testing;
