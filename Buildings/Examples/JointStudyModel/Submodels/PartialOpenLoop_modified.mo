...
partial model PartialOpenLoop_modified
...
public
  ...
  Fluid.Actuators.Valves.TwoWayLinear val(
    redeclare package Medium = MediumW,   m_flow_nominal=m_flow_nominal*1000*(10
         - (-20))/4200/10,
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_a(redeclare package Medium =
        ...
        transformation(extent={{120,-330},{140,-310}}), iconTransformation(
          extent={{10,-110},{30,-90}})));
  Modelica.Fluid.Interfaces.FluidPort_b port_b(redeclare package Medium =
        MediumW)                               annotation (Placement(
        transformation(extent={{80,-330},{100,-310}}), iconTransformation(
          extent={{-30,-110},{-10,-90}})));
equation
  ...
  connect(heaCoi.port_b2, cooCoi.port_a2) annotation (Line(
      ...
      color={0,127,255},
      thickness=0.5));
  connect(val.port_b, heaCoi.port_a1) annotation (Line(points={{130,-150},{130,-52},
          {118,-52}}, color={0,127,255}));
  connect(port_a, val.port_a)
    annotation (Line(points={{130,-320},{130,-170}}, color={0,127,255}));
  connect(port_b, heaCoi.port_b1)
    annotation (Line(points={{90,-320},{90,-52},{98,-52}}, color={0,127,255}));
