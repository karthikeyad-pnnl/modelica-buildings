...
model ConComp
    .Extra.PackageTerminalHeatPump.FinalizedModel.ConCoolingSetting conCoolingSetting annotation(Placement(transformation(extent = {{-28.0,38.0},{-8.0,58.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Extra.PackageTerminalHeatPump.FinalizedModel.ControllerHeatingFan conHeaFan annotation(Placement(transformation(extent = {{100.0,34.0},{120.0,54.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Extra.PackageTerminalHeatPump.FinalizedModel.ConHP conHP annotation(Placement(transformation(extent = {{24.0,-60.0},{44.0,-40.0}},origin = {0.0,0.0},rotation = 0.0)));
...
equation
    ...
    connect(con.y,conCoolingSetting.TSetRooCoo) annotation(Line(points = {{-72,70},{-50.98881247292964,70},{-50.98881247292964,53.99564985138756},{-29.977624945859283,53.99564985138756}},color = {0,0,127}));
    ...
    connect(sin.y,conCoolingSetting.TRoo) annotation(Line(points = {{-72,36},{-50.968302841173035,36},{-50.968302841173035,41.48477447985647},{-29.936605682346073,41.48477447985647}},color = {0,0,127}));
