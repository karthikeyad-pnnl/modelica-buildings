...
model ConCoolingSetting
    ...
    .Buildings.Controls.OBC.CDL.Continuous.Sources.Constant ConMin(k = 1) annotation(Placement(transformation(extent = {{-35.842136013326524,-30.441257972029142},{-15.842136013326524,-10.441257972029142}},origin = {0.0,0.0},rotation = 0.0)));
