...
model ZonalHVACBase
  "Validation model for zonal HVAC system - Base model"
  ...
  inner parameter Buildings.Templates.AirHandlersFans.Validation.UserProject.Data.AllZonalHVACSystems datAll(
    sysUni=Buildings.Templates.Types.Units.SI,
    redeclare replaceable model ZonalHVAC =
        Buildings.Templates.AirHandlersFans.ZonalHVAC)
  ...
  inner replaceable Buildings.Templates.AirHandlersFans.ZonalHVAC VAV_1(
