...
block HeatRecoveryUnitController
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TSupHea "Hot Water Supply Temperature" annotation (Placement(
        transformation(extent={{-140,0},{-100,40}}), iconTransformation(extent={{-140,60},
            {-100,100}})));
...
equation
  ...
  connect(ctlDpHea.y, yPumSpeHea) annotation (Line(points={{142,-40},{154,-40},
