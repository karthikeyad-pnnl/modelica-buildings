...
block CoolingTowerControl
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con(k=273.15 + 12.7)
  ...
  Buildings.Controls.OBC.CDL.Logical.Timer tim(t=900)
...
equation
  ...
  connect(booleanPassThrough.y, mulAnd.u[3]) annotation (Line(points={{-99,40},
          {-94,40},{-94,64},{-34,64},{-34,92.3333},{-30,92.3333}}, color={255,0,
          255}));
  connect(booleanPassThrough.y, and1.u2) annotation (Line(points={{-99,40},{-94,
          40},{-94,64},{-34,64},{-34,92},{-36,92},{-36,112},{78,112}}, color={
          255,0,255}));
  connect(conPID1.y, conPID2.u_s) annotation (Line(points={{-28,10},{54,10},{54,
          40},{78,40}}, color={0,0,127}));
  connect(conPID1.y, hys1.u) annotation (Line(points={{-28,10},{54,10},{54,74},
          {52,74},{52,80},{58,80}}, color={0,0,127}));
  connect(conPID1.y, swi.u1) annotation (Line(points={{-28,10},{54,10},{54,-12},
          {78,-12}}, color={0,0,127}));
