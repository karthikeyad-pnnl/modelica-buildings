...
model ValvesIsolation_UpdatePorts
...
//       have_chiWat
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_aHeaWat(
    ...
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-2080,8})));
  Modelica.Fluid.Interfaces.FluidPorts_b ports_bHeaWatHp[nHp](
    redeclare each final package Medium = Medium,
    each m_flow(max=if allowFlowReversal then +Modelica.Constants.inf else 0),
    each h_outflow(start=Medium.h_default, nominal=Medium.h_default))
    "HW return (HP entering)" annotation (Placement(transformation(
        extent={{-10,-40},{10,40}},
        rotation=90,
        origin={-1774,-340}), iconTransformation(
        extent={{-10,-40},{10,40}},
        rotation=90,
        origin={-1920,-338})));
      //if
  ...
  */
  ...
  Modelica.Fluid.Interfaces.FluidPorts_b ports_bChiWatHp[nHp](
    ...
    "CHW return (HP entering)" annotation (Placement(transformation(
        extent={{-10,-40},{10,40}},
        rotation=90,
        origin={-1704,-340}), iconTransformation(
        extent={{-10,-40},{10,40}},
        rotation=90,
        origin={-1712,-338})));
protected
...
equation
  ...
  connect(ports_aChiWatHp, valChiWatHpOutIso.port_a)
    annotation (Line(points={{-1962,-340},{-1962,-160},{-1974,-160},{-1974,-150}},
                                                                           color={0,127,255}));
  ...
  connect(ports_aChiWatHp, pasChiWatHpOut.port_a)
    annotation (Line(points={{-1962,-340},{-1962,-160},{-1954,-160},{-1954,-150}},
      color={0,127,255}));
  ...
  connect(pasHeaWatHpInl.port_b, ports_bHeaWatHp) annotation (Line(points={{-1794,
          -150},{-1794,-340},{-1774,-340}}, color={0,127,255}));
  connect(valHeaWatHpInlIso.port_b, ports_bHeaWatHp)
    annotation (Line(points={{-1774,-150},{-1774,-340}}, color={0,127,255}));
  ...
  connect(pasChiWatHpInl.port_b, ports_bChiWatHp) annotation (Line(points={{-1714,
          -150},{-1704,-150},{-1704,-340}}, color={0,127,255}));
  connect(valChiWatHpInlIso.port_b, ports_bChiWatHp) annotation (Line(points={{-1694,
          -150},{-1692,-150},{-1692,-340},{-1704,-340}}, color={0,127,255}));
  annotation (
    ...
    Icon(
      coordinateSystem(
        ...
        Line(
          points={{-2018,-314},{-2018,-78},{-2066,-78}},
          color={238,46,47},
          thickness=1),
        Line(
          points={{-1918,-324},{-1918,12},{-2068,12}},
          color={238,46,47},
          thickness=1),
        Line(
          points={{-1822,-326},{-1822,10},{-1672,10}},
          color={28,108,200},
          thickness=1),
        Line(
          points={{-1720,-322},{-1720,-86},{-1672,-86}},
          color={28,108,200},
          thickness=1)}),
    Documentation(
      info="<html>
...
end ValvesIsolation_UpdatePorts;
