...
model ExternalEnergyLoopIntegration_Atlanta "Control Box Test"
  ...
  parameter Buildings.Templates.Components.Data.PumpMultiple datPumMulCoo(
    ...
    dp_nominal=fill(1.8*1e6, pum.nPum),
...
end ExternalEnergyLoopIntegration_Atlanta;
