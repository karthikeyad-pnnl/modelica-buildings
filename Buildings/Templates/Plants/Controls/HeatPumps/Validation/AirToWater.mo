...
equation
  ...
  connect(y1PumHeaWatSec_actual.y1_actual, ctl.u1PumHeaWatSec_actual)
    annotation (Line(points={{122,0},{138,0},{138,86},{-10,86},{-10,38.2},{-2,
          38.2}},
      color={255,0,255}));
  connect(y1PumChiWatPri_actual.y1_actual, ctl.u1PumChiWatPri_actual)
    annotation (Line(points={{92,20},{136,20},{136,84},{-8,84},{-8,40.2},{-2,
          40.2}},
      color={255,0,255}));
  connect(y1PumChiWatSec_actual.y1_actual, ctl.u1PumChiWatSec_actual)
    annotation (Line(points={{92,-20},{140,-20},{140,88},{-12,88},{-12,36.2},{
          -2,36.2}},
      color={255,0,255}));
  ...
  connect(y1Hrc_actual.y1_actual, ctl.u1Hrc_actual)
    annotation (Line(points={{122,-40},{142,-40},{142,90},{-14,90},{-14,34.2},{
          -2,34.2}},
      color={255,0,255}));
  ...
  connect(ctl.THeaWatSupSet, THeaWatRet.u1)
    annotation (Line(points={{42,-6},{46,-6},{46,176},{-86,176},{-86,166},{-82,
          166}},
      color={0,0,127}));
  ...
  connect(ctl.TChiWatSupSet, TChiWatRet.u2)
    annotation (Line(points={{42,-8},{44,-8},{44,126},{-120,126},{-120,134},{
          -112,134}},
      color={0,0,127}));
  ...
  connect(TChiWatRetUpsHrc.u2, ctl.TChiWatSupSet)
    annotation (Line(points={{-112,174},{-120,174},{-120,126},{44,126},{44,-8},
          {42,-8}},
      color={0,0,127}));
  connect(THeaWatRetUpsHrc.u2, ctl.THeaWatSupSet)
    annotation (Line(points={{-82,194},{-86,194},{-86,176},{46,176},{46,-6},{42,
          -6}},
      color={0,0,127}));
  ...
  connect(ctl1.y1PumChiWatPri, y1PumChiWatPri_actual1.y1) annotation (Line(
        points={{258,30},{270,30},{270,20},{278,20}},         color={255,0,255}));
  connect(ctl1.y1PumHeaWatSec, y1PumHeaWatSec_actual1.y1) annotation (Line(
        points={{258,26},{266,26},{266,0},{308,0}},         color={255,0,255}));
  connect(ctl1.y1PumChiWatSec, y1PumChiWatSec_actual1.y1) annotation (Line(
        points={{258,24},{262,24},{262,-20},{278,-20}},     color={255,0,255}));
  connect(y1Hp_actual1.y1_actual, ctl1.u1Hp_actual) annotation (Line(points={{302,60},
          {310,60},{310,76},{208,76},{208,44.2},{214,44.2}},           color={255,
          0,255}));
  connect(y1PumHeaWatPri_actual2.y1_actual, ctl1.u1PumHeaWatPri_actual)
    annotation (Line(points={{332,40},{340,40},{340,80},{206,80},{206,42.2},{
          214,42.2}},
                   color={255,0,255}));
  connect(y1PumChiWatPri_actual1.y1_actual, ctl1.u1PumChiWatPri_actual)
    annotation (Line(points={{302,20},{342,20},{342,82},{204,82},{204,40.2},{
          214,40.2}},
                   color={255,0,255}));
  connect(y1PumHeaWatSec_actual1.y1_actual, ctl1.u1PumHeaWatSec_actual)
    annotation (Line(points={{332,0},{344,0},{344,86},{202,86},{202,38.2},{214,
          38.2}},  color={255,0,255}));
  connect(y1PumChiWatSec_actual1.y1_actual, ctl1.u1PumChiWatSec_actual)
    annotation (Line(points={{302,-20},{346,-20},{346,90},{200,90},{200,36.2},{
          214,36.2}},      color={255,0,255}));
  connect(reqPlaHeaWat.y, ctl1.nReqPlaHeaWat) annotation (Line(points={{-58,110},
          {-40,110},{-40,142},{114,142},{114,92},{196,92},{196,28},{214,28}},
        color={255,127,0}));
  connect(reqPlaChiWat.y, ctl1.nReqPlaChiWat) annotation (Line(points={{-58,70},
          {-24,70},{-24,128},{144,128},{144,26},{214,26}},         color={255,127,
          0}));
  connect(reqResHeaWat.y, ctl1.nReqResHeaWat) annotation (Line(points={{-58,40},
          {-40,40},{-40,24},{-22,24},{-22,70},{-14,70},{-14,92},{114,92},{114,
          126},{160,126},{160,30},{214,30},{214,24},{214,24}},color={255,127,0}));
  connect(reqResChiWat.y, ctl1.nReqResChiWat) annotation (Line(points={{-58,10},
          {-40,10},{-40,-52},{180,-52},{180,22},{214,22}},         color={255,127,
          0}));
  connect(ctl1.THeaWatSupSet, ctl1.THeaWatPriSup) annotation (Line(points={{258,-6},
          {264,-6},{264,-28},{210,-28},{210,18},{214,18}},             color={0,
          0,127}));
  connect(ctl1.TChiWatSupSet, ctl1.TChiWatPriSup) annotation (Line(points={{258,-8},
          {266,-8},{266,-30},{208,-30},{208,12},{214,12}},
        color={0,0,127}));
  connect(ctl1.THeaWatSupSet, ctl1.THeaWatSecSup) annotation (Line(points={{258,-6},
          {264,-6},{264,-28},{210,-28},{210,6},{214,6}},             color={0,0,
          127}));
  connect(TOut.y, ctl1.TOut) annotation (Line(points={{-168,92},{168,92},{168,
          20},{214,20}},   color={0,0,127}));
  connect(ctl1.THeaWatSupSet, THeaWatRet1.u1) annotation (Line(points={{258,-6},
          {264,-6},{264,-28},{210,-28},{210,16},{176,16},{176,132},{222,132},{
          222,176},{188,176}},  color={0,0,127}));
  connect(ctl1.TChiWatSupSet, TChiWatRet1.u2) annotation (Line(points={{258,-8},
          {266,-8},{266,-30},{208,-30},{208,12},{156,12},{156,134},{150,134},{
          150,144},{158,144}},       color={0,0,127}));
  connect(THeaWatRet1.y, ctl1.THeaWatPriRet) annotation (Line(points={{212,170},
          {216,170},{216,16},{214,16}},         color={0,0,127}));
  connect(TChiWatRet1.y, ctl1.TChiWatPriRet) annotation (Line(points={{182,150},
          {190,150},{190,8},{214,8},{214,10}},             color={0,0,127}));
  connect(VHeaWat_flow.y, ctl1.VHeaWatSec_flow) annotation (Line(points={{-88,-20},
          {66,-20},{66,0},{214,0}},         color={0,0,127}));
  connect(ctl1.TChiWatSupSet, ctl1.TChiWatSecSup) annotation (Line(points={{258,-8},
          {266,-8},{266,-30},{208,-30},{208,-2},{214,-2}},
        color={0,0,127}));
  connect(VChiWat_flow.y, ctl1.VChiWatSec_flow) annotation (Line(points={{-58,-40},
          {82,-40},{82,-8},{214,-8}},         color={0,0,127}));
  ...
  connect(dpHeaWatRem1[1].y, dpHeaWatLoc1.u) annotation (Line(points={{182,-90},
          ...
          -170}},                                                  color={0,0,127}));
  connect(ctl1.dpHeaWatRemSet, resDpHeaWatLoc1.dpRemSet) annotation (Line(points={{258,0},
          {272,0},{272,-168},{198,-168},{198,-144}},
                       color={0,0,127}));
  connect(dpChiWatRem1[1].y, dpChiWatLoc1.u) annotation (Line(points={{182,-130},
          ...
          -212}},                                                  color={0,0,127}));
  connect(ctl1.dpChiWatRemSet, resDpChiWatLoc1.dpRemSet) annotation (Line(points={{258,-2},
          {260,-2},{260,-36},{252,-36},{252,-208},{192,-208},{192,-200},{188,
          -200},{188,-184},{198,-184}},                                color={0,
          0,127}));
  ...
  connect(resDpChiWatLoc1.dpLocSet, ctl1.dpChiWatLocSet) annotation (Line(points={{221.8,
          ...
          -44},{196,-18},{214,-18}},                   color={0,0,127}));
  connect(dpChiWatLoc1.y, ctl1.dpChiWatLoc) annotation (Line(points={{182,-212},
          {242,-212},{242,-56},{188,-56},{188,-20},{214,-20}},
                   color={0,0,127}));
  connect(dpHeaWatLoc1.y, ctl1.dpHeaWatLoc) annotation (Line(points={{182,-170},
          {228,-170},{228,-156},{232,-156},{232,-40},{200,-40},{200,-12},{214,
          -12},{214,-14}},
                   color={0,0,127}));
  connect(resDpHeaWatLoc1.dpLocSet, ctl1.dpHeaWatLocSet) annotation (Line(points={{221.8,
          -150},{221.8,-152},{228,-152},{228,-36},{204,-36},{204,-12},{214,-12}},
                                                       color={0,0,127}));
  connect(ctl1.dpHeaWatRemSet, dpHeaWatRem1.u1) annotation (Line(points={{258,0},
          {264,0},{264,2},{268,2},{268,-74},{150,-74},{150,-84},{158,-84}},
                      color={0,0,127}));
  connect(ctl1.dpChiWatRemSet, dpChiWatRem1.u1) annotation (Line(points={{258,-2},
          {260,-2},{260,-36},{252,-36},{252,-124},{190,-124},{190,-114},{150,
          -114},{150,-124},{158,-124}},            color={0,0,127}));
  annotation (
    __Dymola_Commands(
      file=
