...
model AirToWater_HybridHeatPumpPlant
  ...
  Buildings.Templates.Plants.HeatPumps.AirToWater pla(
    ...
    linearized=true,
    show_T=true,
    redeclare Buildings.Templates.Plants.HeatPumps.Components.Interfaces.PartialController ctl(nAirHan=1, nEquZon=0),
  ...
  Components.Controls.HybridAirToWater ctl
    annotation (Placement(transformation(extent={{-160,-120},{-140,-100}})));
  Buildings.Templates.Components.Interfaces.Bus busHp[2] annotation (Placement(
        transformation(extent={{-130,-100},{-90,-60}}), iconTransformation(
          extent={{-304,-138},{-264,-98}})));
  Interfaces.Bus busPla1
                        "Plant control bus"
    annotation (Placement(transformation(extent={{-128,-152},{-88,-112}}),
      iconTransformation(extent={{-370,-70},{-330,-30}})));
  Buildings.Templates.Components.Interfaces.Bus busHp1[2] annotation (Placement(
        transformation(extent={{-160,-100},{-120,-60}}), iconTransformation(
          extent={{-304,-138},{-264,-98}})));
equation
  if have_chiWat then
  ...
  connect(weaDat.weaBus, pla.busWea)
    annotation (Line(points={{-170,-10},{-52,-10},{-52,-72},{-60,-72},{-60,-80}},
  ...
  connect(busPla.hp[1:2], busHp) annotation (Line(
      points={{-80,-40},{-110,-40},{-110,-80}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(busPla1, pla.bus) annotation (Line(
      points={{-108,-132},{-88,-132},{-88,-72},{-80,-72},{-80,-82}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
...
end AirToWater_HybridHeatPumpPlant;
