...
equation
  ...
  connect(conInt.y, extIndInt.u)
    annotation (Line(points={{-498,-490},{-482,-490}},
                                                 color={255,127,0}));
  connect(ctl.yMod[3], extIndInt.index) annotation (Line(points={{-345.714,
          29.1628},{-316,29.1628},{-316,144},{-564,144},{-564,-112},{-604,-112},
          {-604,-512},{-470,-512},{-470,-502}},            color={255,127,0}));
  ...
  connect(ctl.TSupSet[1:2], busHp.TSet) annotation (Line(points={{-345.714,
          -11.5814},{-320,-11.5814},{-320,140},{-536,140},{-536,104},{-502,104}},
                                                             color={0,0,127}),
      Text(
      string="%second",
      index=1,
  ...
  connect(greThr.y, ctl.u1PumChiWatPri_actual[3]) annotation (Line(points={{-142,
          -406},{-262,-406},{-262,25.4233},{-377.143,25.4233}},
                                                      color={255,0,255}));
  connect(greThr1.y, ctl.u1PumHeaWatPri_actual[3]) annotation (Line(points={{-202,
          -510},{-264,-510},{-264,27.0977},{-377.143,27.0977}},
                                                      color={255,0,255}));
  ...
  connect(ctl.TSupSet[3], conPIDCoo.u_s) annotation (Line(points={{-345.714,
          -11.0233},{-274,-11.0233},{-274,-306},{-170,-306},{-170,-330},{-178,
          -330}},
        color={0,0,127}));
  connect(ctl.TSupSet[3], conPIDHea.u_s) annotation (Line(points={{-345.714,
          -11.0233},{-220,-11.0233},{-220,-476},{-102,-476}},
                                                    color={0,0,127}));
  ...
  connect(ctl.y1PumChiWatPri[3], booToRea.u) annotation (Line(points={{-345.714,
          16.8837},{-136,16.8837},{-136,52},{-8,52},{-8,76},{104,76},{104,-96},
          {140,-96},{140,-386},{-8,-386}},
                            color={255,0,255}));
  connect(ctl.y1Hp[3], and1.u2) annotation (Line(points={{-345.714,32.5116},{
          -334,32.5116},{-334,-364},{-332,-364}},
                                    color={255,127,0}));
  connect(ctl.y1Hp[3], and3.u2) annotation (Line(points={{-345.714,32.5116},{
          -345.714,-185},{-332,-185},{-332,-404}},
                                    color={255,127,0}));
  connect(ctl.y1PumHeaWatPri[3], booToRea1.u) annotation (Line(points={{
          -345.714,18.5581},{-312,18.5581},{-312,88},{-188,88},{-188,200},{200,
          200},{200,-456},{-8,-456}},
        color={255,0,255}));
  connect(ctl.y1PumChiWatSec[1], booToRea2.u) annotation (Line(points={{
          -345.714,11.8605},{-230,11.8605},{-230,-40},{-142,-40}},
                                            color={255,0,255}));
  connect(ctl.y1PumHeaWatSec[1], booToRea5.u) annotation (Line(points={{
          -345.714,13.5349},{-176,13.5349},{-176,-76},{-164,-76},{-164,-212},{
          12,-212},{12,-470},{18,-470}},
        color={255,0,255}));
  ...
  connect(booToRea2.y, mul2.u1) annotation (Line(points={{-118,-40},{-118,-34},{
          -92,-34}}, color={0,0,127}));
  connect(ctl.yPumChiWatSec, mul2.u2) annotation (Line(points={{-345.714,
          0.139535},{-204,0.139535},{-204,-60},{-100,-60},{-100,-46},{-92,-46}},
                                                       color={0,0,127}));
  connect(booToRea5.y, mul3.u1)
    annotation (Line(points={{42,-470},{58,-470},{58,-474}}, color={0,0,127}));
  connect(ctl.yPumHeaWatSec, mul3.u2) annotation (Line(points={{-345.714,
          1.81395},{-194,1.81395},{-194,-486},{58,-486}},
                                  color={0,0,127}));
  ...
  connect(greThr4.y, busSen.y1PumHeaWatSec_actual) annotation (Line(points={{-42,
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(ctl.y1PumHeaWatSec[1], pre.u) annotation (Line(points={{-345.714,
          13.5349},{-308,13.5349},{-308,80},{-358,80}},
                                    color={255,0,255}));
  connect(pre.y, ctl.u1PumHeaWatSec_actual[1]) annotation (Line(points={{-382,80},
          {-400,80},{-400,23.7488},{-377.143,23.7488}},
                                              color={255,0,255}));
  ...
  connect(mulInt[1].y, ctl.nReqResChiWat) annotation (Line(points={{-22,132},{
          -442,132},{-442,10.186},{-377.143,10.186}},
                                          color={255,127,0}));
  connect(mulInt[2].y, ctl.nReqPlaChiWat) annotation (Line(points={{-22,132},{
          -444,132},{-444,16},{-392,16},{-392,13.5349},{-377.143,13.5349}},
                                                              color={255,127,0}));
  connect(mulInt[3].y, ctl.nReqResHeaWat) annotation (Line(points={{-22,132},{
          -444,132},{-444,11.8605},{-377.143,11.8605}},
                                          color={255,127,0}));
  connect(mulInt[4].y, ctl.nReqPlaHeaWat) annotation (Line(points={{-22,132},{
          -444,132},{-444,16},{-392,16},{-392,15.2093},{-377.143,15.2093}},
                                                              color={255,127,0}));
  connect(pre1.y, ctl.u1PumChiWatSec_actual[1]) annotation (Line(points={{-358,60},
          {-392,60},{-392,22.0744},{-377.143,22.0744}},
                                                  color={255,0,255}));
  connect(ctl.y1PumChiWatSec[1], pre1.u) annotation (Line(points={{-345.714,
          11.8605},{-326,11.8605},{-326,60},{-334,60}},
                                         color={255,0,255}));
