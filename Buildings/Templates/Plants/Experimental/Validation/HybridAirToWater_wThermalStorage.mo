...
model HybridAirToWater_wThermalStorage "Validation of AWHP plant template"
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiOr mulOr(nin=pumHeaWatSec.dat.nPum)
    annotation (Placement(transformation(extent={{-20,80},{0,100}})));
  Fluid.Sensors.TemperatureTwoPort senTem1(redeclare package Medium = Medium,
      m_flow_nominal=pla.mHeaWat_flow_nominal) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={150,-230})));
  Fluid.Actuators.Valves.TwoWayLinear val1(
    redeclare package Medium = Medium,
    m_flow_nominal=pla.mHeaWat_flow_nominal,
    dpValve_nominal=1e-6) annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=270,
        origin={150,-268})));
...
equation
  ...
  connect(busAirHan, pla.busAirHan) annotation (Line(
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(tanSim.port_b, junHWBypRet.port_3)
    annotation (Line(points={{150,-310},{150,-330}}, color={0,127,255}));
  connect(junHWBypSup.port_2, pumHeaWatSecInl.port_a) annotation (Line(points={{160,
          -180},{168,-180},{168,-164},{54,-164},{54,-96},{-14,-96},{-14,-80},{
          -8,-80}},       color={0,127,255}));
  connect(junHWBypRet.port_1, senTemHeaWatSecRet.port_a) annotation (Line(
        points={{160,-340},{166,-340},{166,-356},{86,-356},{86,-136},{70,-136},
          {70,-120},{76,-120}},                      color={0,127,255}));
  connect(senTemHeaWatPriRet.port_b, val.port_2)
    annotation (Line(points={{-62,-120},{-50,-120}}, color={0,127,255}));
  connect(VHeaWatPri_flow.port_b, junHWBypSup.port_1) annotation (Line(points={{-38,-80},
          {-18,-80},{-18,-168},{130,-168},{130,-180},{140,-180}},
                       color={0,127,255}));
  connect(junHWBypRet.port_2, val.port_1) annotation (Line(points={{140,-340},{
          56,-340},{56,-120},{-30,-120}},                     color={0,127,255}));
  connect(VHeaWatPri_flow.port_b, val.port_3) annotation (Line(points={{-38,-80},
          {-18,-80},{-18,-104},{-40,-104},{-40,-110}}, color={0,127,255}));
  connect(senTemHeaWatPriSup.T, primaryWarmup.TSup) annotation (Line(points={{-74,-69},
          {-74,-56},{62,-56},{62,-16},{96,-16},{96,74},{70,74},{70,94},{78,94}},
                color={0,0,127}));
  connect(busPla.THeaWatSupSet, primaryWarmup.TSupSet) annotation (Line(
      points={{-180,0},{-180,26},{-36,26},{-36,72},{68,72},{68,98},{78,98}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(senTem.port, tanSim.fluPorVol[10]) annotation (Line(points={{210,-340},
          ...
          166,-298.2},{155,-298.2}},
        color={0,127,255}));
  connect(senTem.T, tankCharging.TTanBot) annotation (Line(points={{217,-330},{
          226,-330},{226,-178},{200,-178},{200,-156},{218,-156}},
                                                              color={0,0,127}));
  connect(busWea.TDryBul, tankCharging.TOut) annotation (Line(
      points={{-99.9,180.1},{-99.9,160},{200,160},{200,-152},{218,-152}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(tankCharging.nReqPlaHea, busPla.tankReq) annotation (Line(points={{242,
          -158},{252,-158},{252,62},{-180,62},{-180,0}},
  ...
  connect(tankCharging.yChaZer, primaryWarmup.uChaZero) annotation (Line(points={{242,
          -162},{244,-162},{244,76},{74,76},{74,82.2},{78,82.2}},
                                                   color={255,0,255}));
  connect(mulOr.y, primaryWarmup.uPlaEna) annotation (Line(points={{2,90},{66,
          90},{66,90},{78,90}},
                            color={255,0,255}));
  connect(busPla.pumHeaWatSec.y1, mulOr.u) annotation (Line(
      points={{-180,0},{-180,26},{-182,26},{-182,78},{-32,78},{-32,90},{-22,90}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(primaryWarmup.yWarUp, val.y) annotation (Line(points={{102,90},{190,
          90},{190,-148},{-40,-148},{-40,-132}},
                                      color={0,0,127}));
  connect(tankCharging.nReqResHea, busPla.tankReqRes) annotation (Line(points={{242,
          -154},{248,-154},{248,58},{-180,58},{-180,0}},      color={255,127,0}),
      Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
  ...
  connect(val2.port_b, junHWBypRet.port_3) annotation (Line(points={{170,-280},
          {170,-324},{150,-324},{150,-330}}, color={0,127,255}));
  ...
  connect(senTem1.T, tankCharging.TTanInl) annotation (Line(points={{161,-230},
          {190,-230},{190,-160},{218,-160}}, color={0,0,127}));
  connect(senTem2.T, tankCharging.TTanTop) annotation (Line(points={{217,-290},
          {224,-290},{224,-176},{202,-176},{202,-164},{218,-164}}, color={0,0,
          127}));
  connect(senVolFlo.V_flow, tankCharging.VTan_flow) annotation (Line(points={{
          161,-206},{204,-206},{204,-168},{218,-168}}, color={0,0,127}));
  connect(tankCharging.yValTan, val1.y) annotation (Line(points={{242,-166},{
          252,-166},{252,-250},{130,-250},{130,-268},{138,-268}}, color={0,0,
          127}));
  connect(tankCharging.yValTan, gai.u) annotation (Line(points={{242,-166},{252,
          -166},{252,-250},{50,-250},{50,-286},{58,-286}}, color={0,0,127}));
...
First implementation.
    ...
    Icon(coordinateSystem(extent={{-240,-360},{260,180}})));
