...
block PlantEnable "Sequence to enable and disable plant"
  ...
  parameter Modelica.SIunits.Temperature TLocOut=277.5
  ...
  parameter Buildings.Controls.OBC.ASHRAE.PrimarySystem.Generic.Types.SystemTypes systemType = Buildings.Controls.OBC.ASHRAE.PrimarySystem.Generic.Types.SystemTypes.boilerPlant
  "Type of plant";
  ...
  CDL.Continuous.AddParameter addPar(p=if systemType == Buildings.Controls.OBC.ASHRAE.PrimarySystem.Generic.Types.SystemTypes.boilerPlant then -TLocOut else TLocOut,
                                     k=if systemType == Buildings.Controls.OBC.ASHRAE.PrimarySystem.Generic.Types.SystemTypes.boilerPlant then 1 else -1)
...
equation
  ...
  connect(addPar.u, TOut)
    annotation (Line(points={{-142,-130},{-220,-130}}, color={0,0,127}));
...
<li>
Outdoor air temperature is greater than plant lockout temperature, 
...
<li>
Outdoor air temperature is 1 &deg;F less than plant lockout temperature,
