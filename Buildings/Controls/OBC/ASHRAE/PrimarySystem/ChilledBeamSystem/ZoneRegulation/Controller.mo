...
block Controller "Controller for room CAV box and chilled beam manifold"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yChiVal(
    final min=0,
    final max=1,
    final unit="1") "Signal for chilled beam manifold valve" annotation (
      Placement(transformation(extent={{140,-20},{180,20}}), iconTransformation(
  ...
  CDL.Interfaces.RealOutput yReh(
    ...
    final unit="1") "Reheat signal to CAV terminal" annotation (Placement(
        transformation(extent={{140,20},{180,60}}), iconTransformation(extent={
            {100,-10},{140,30}})));
protected
...
equation
  ...
  connect(sysReq.VDisSet_flow, damVal.VDisSet_flow)
    annotation (Line(points={{78,-88},{64,-88},{64,68},{52,68}},
      color={0,0,127}));
  ...
  connect(conCooLoo.y, damVal.uCoo)
    annotation (Line(points={{-88,120},{8,120},{8,70},{28,70}},
      color={0,0,127}));
  connect(conHeaLoo.y, damVal.uHea)
    annotation (Line(points={{-88,160},{12,160},{12,58},{28,58}},
      color={0,0,127}));
  connect(conCooLoo.y, sysReq.uCoo)
    annotation (Line(points={{-88,120},{8,120},{8,-86},{78,-86}},
      color={0,0,127}));
  connect(damVal.uOpeMod, uOpeMod) annotation (Line(points={{28,50},{-112,50},{
          -112,-170},{-160,-170}},color={255,127,0}));
  ...
  connect(damVal.yHeaVal, yReh) annotation (Line(points={{52,56},{100,56},{100,
