...
model SystemController
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeamSystem.SystemController
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChilledBeamSystem/Validation/SystemController.mos"
    "Simulate and plot"),
