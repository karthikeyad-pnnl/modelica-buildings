...
annotation (
  experiment(
    ...
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChilledBeamSystem/SecondaryPumps/Subsequences/Validation/EnableLead.mos"
    "Simulate and plot"),
