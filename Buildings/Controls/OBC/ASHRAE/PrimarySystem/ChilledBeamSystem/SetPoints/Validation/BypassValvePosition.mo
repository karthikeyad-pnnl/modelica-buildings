...
model BypassValvePosition
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeamSystem.SetPoints.BypassValvePosition
    bypValPos "Bypass valve position setpoint controller"
    annotation (Placement(transformation(extent={{0,-10},{20,10}})));

protected
  CDL.Continuous.Sources.Pulse pul(
    amplitude=0.1,
    period=2000,
    shift=10,
    offset=0.1) "Real pulse source"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  CDL.Continuous.Sources.Sine sin(
    amplitude=10000,
    freqHz=1/1000,
    offset=45000) "Real sine source"
    annotation (Placement(transformation(extent={{-80,-50},{-60,-30}})));

  CDL.Logical.Sources.Pulse                        booPul[2](final period=fill(4000,
        2), shift=fill(10, 2))
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChilledBeamSystem/SetPoints/Validation/BypassValvePosition.mos"
    "Simulate and plot"),
