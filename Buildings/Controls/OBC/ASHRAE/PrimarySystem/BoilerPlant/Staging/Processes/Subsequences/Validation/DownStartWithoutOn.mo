...
model DownStartWithoutOn
    ...
    "Validate sequence of starting the staging down process which does not require enabling a boiler"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.Processes.Subsequences.DownStart
    ...
    "Boiler stage down when the process does not require one boiler on and another boiler off"
...
annotation (
 experiment(StopTime=1200, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/BoilerPlant/Staging/Processes/Subsequences/Validation/DownStartWithoutOn.mos"
    "Simulate and plot"),
