...
model DownStartWithOn
    "Validate sequence of starting the staging down process which requires enabling a boiler"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.Processes.Subsequences.DownStart
    ...
    "Boiler stage down when the process does require one boiler on and another boiler off"
...
protected
  ...
  Buildings.Controls.OBC.CDL.Logical.Switch chiLoa1[2]
    "Boiler load"
...
annotation (
 experiment(StopTime=1200, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/BoilerPlant/Staging/Processes/Subsequences/Validation/DownStartWithOn.mos"
    "Simulate and plot"),
