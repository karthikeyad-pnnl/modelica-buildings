...
block DownStart
  ...
  parameter Real proOnTim(
    ...
    annotation (Dialog(group="Disable last boiler"));
...
protected
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.Processes.Subsequences.CHWIsoVal
    ...
    final iniValPos=0,
    final endValPos=1)
    "Enable boiler hot water isolation valve
    "
  ...
  Buildings.Controls.OBC.CDL.Logical.LogicalSwitch heaPreCon[nBoi]
    "Logical switch"
    annotation (Placement(transformation(extent={{140,-20},{160,0}})));

  Buildings.Controls.OBC.CDL.Logical.Switch chiDem[nBoi]
    "Boiler demand"
  ...
  Buildings.Controls.OBC.CDL.Logical.Switch chiWatIsoVal[nBoi]
  ...
  Buildings.Controls.OBC.CDL.Logical.Latch lat1
    "Maintain ON signal when minimum hot water setpoint has been set"
  ...
  Buildings.Controls.OBC.CDL.Logical.Latch lat3
    "Maintain ON signal when boiler head control has been enabled"
    annotation (Placement(transformation(extent={{60,-50},{80,-30}})));

  Buildings.Controls.OBC.CDL.Logical.Latch lat4
    "Maintain ON signal when hot water isolation valve has been enabled"
...
equation
  ...
  connect(minBoiWatSet.yChiWatMinFloSet, minBypRes.VMinHotWatSet_flow)
    annotation (Line(points={{22,70},{40,70},{40,102},{58,102}}, color={0,0,127}));
  ...
  connect(lat2.y, minBoiWatSet.uSubCha)
  ...
  connect(minBoiWatSet.yChiWatMinFloSet, yChiWatMinFloSet)
...
<p>
Block that controls devices at the first step of boiler staging down process.
...
<p>
For the stage-down process that requires a smaller boiler being enabled and a
larger boiler being disabled (<code>uOnOff=true</code>): 
</p>
<ol>
<li>
...
demand &lt;
 ...
 80% of current load up to a maximum of 5 minutes (<code>holChiDemTim</code>) 
...
<li>
Slowly change the minimum hot water flow setpoint to that approriate for the
stage transition (<code>minBoiWatSet</code>). After new setpoint is achieved, wait 
...
<li>
Slowly open hot water isolation valve of the smaller boiler being enabled.
...
Wait 5 minutes (<code>proOnTim</code>) after the newly enabled boiler to prove that 
it is operating correctly, then shut off the larger boiler and release the demand 
...
the last stage boiler. This is implemented in block <code>disChi</code>, see
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.Processes.Subsequences.DisableBoiler\">
Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.Processes.Subsequences.DisableBoiler</a>
for more decriptions.
</p>
