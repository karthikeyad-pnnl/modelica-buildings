...
block NextBoiler "Identify next enable and disable boilers"
  ...
  parameter Integer nBoi=2 "Total number of boilers";
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiOr anyEnaBoi(final nu=nBoi)
    "Check if there is any enabling boiler"
    annotation (Placement(transformation(extent={{-80,-30},{-60,-10}})));
  Buildings.Controls.OBC.CDL.Logical.MultiOr anyDisBoi(final nu=nBoi)
  ...
  Buildings.Controls.OBC.CDL.Integers.MultiSum enaBoiInd(final nin=nBoi)
    "Enabling boiler index"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  Buildings.Controls.OBC.CDL.Integers.MultiSum disBoiInd(final nin = nBoi)
...
protected
  parameter Integer chiInd[nChi]={i for i in 1:nBoi}
    "Boiler index, {1,2,...,n}";
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant boiIndVec[nBoi](final k=
        boiInd) "Vector of boiler index"
    annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
  Buildings.Controls.OBC.CDL.Routing.BooleanReplicator booRep(final nout=nBoi)
