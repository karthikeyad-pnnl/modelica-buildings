...
model DisableBoiler
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.Processes.Subsequences.DisableBoiler
    chiOnOff(
    final nBoi=3, final proOnTim=300)
...
protected
  ...
  Buildings.Controls.OBC.CDL.Logical.LogicalSwitch chiTwo
    "Boiler two status"
  ...
  Buildings.Controls.OBC.CDL.Logical.LogicalSwitch chiTwo1
    "Boiler two status"
    annotation (Placement(transformation(extent={{140,-50},{160,-30}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Constant noUpDev(
    final k=false)
    "Constant false"
