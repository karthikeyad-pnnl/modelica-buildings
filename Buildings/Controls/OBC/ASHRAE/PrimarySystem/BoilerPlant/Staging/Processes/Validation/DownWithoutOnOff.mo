...
model DownWithoutOnOff
    "Validate sequence of staging down process which does require boiler ON"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.Processes.Down
    ...
    "Stage down process when does not require boiler on and off"
...
protected
  ...
  Buildings.Controls.OBC.CDL.Logical.Switch IsoVal[2]
    "Logical switch"
...
equation
  ...
  connect(pre2.y, dowProCon.uChi)
    annotation (Line(points={{122,40},{140,40},{140,0},{-28,0},{-28,78},{38,78}},
      color={255,0,255}));
  ...
  connect(IsoVal.y, dowProCon.uChiWatIsoVal)
    annotation (Line(points={{2,-230},{14,-230},{14,67},{38,67}},
      color={0,0,127}));

  connect(pre2.y, dowProCon.uChiWatReq)
    annotation (Line(points={{122,40},{140,40},{140,0},{16,0},{16,64},{38,64}},
      color={255,0,255}));

  connect(pre2.y, dowProCon.uConWatReq)
    annotation (Line(points={{122,40},{140,40},{140,0},{18,0},{18,62},{38,62}},
      color={255,0,255}));

  connect(pre2.y, dowProCon.uChiConIsoVal)
    annotation (Line(points={{122,40},{140,40},{140,0},{20,0},{20,59},{38,59}},
      color={255,0,255}));

  connect(wseSta.y, dowProCon.uWSE)
    annotation (Line(points={{-118,-270},{22,-270},{22,56},{38,56}},
      color={255,0,255}));
  ...
  connect(zerOrdHol1.y, dowProCon.uConWatPumSpeSet)
    annotation (Line(points={{122,-80},{140,-80},{140,-160},{24,-160},{24,53},{38,
          53}}, color={0,0,127}));
  ...
  connect(zerOrdHol2.y, dowProCon.uConWatPumSpe)
    annotation (Line(points={{122,-120},{130,-120},{130,-140},{26,-140},{26,51},
          {38,51}}, color={0,0,127}));
  ...
  connect(chiSet2.y, dowProCon.uChiSet) annotation (Line(points={{2,130},{12,130},
          {12,86.2},{38,86.2}},   color={255,0,255}));

  connect(staSet2.y, dowProCon.uStaSet) annotation (Line(points={{2,210},{20,210},
          {20,88.2},{38,88.2}},   color={255,127,0}));
...
annotation (
 experiment(StopTime=1500, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/BoilerPlant/Staging/Processes/Validation/DownWithoutOnOff.mos"
    "Simulate and plot"),
...
Icon(coordinateSystem(extent={{-100,-100},{100,100}}),
     graphics={
        ...
        Text(
          ...
          lineColor={0,0,127},
          textString="from stage 2 which has boiler one and two enabled,
    "), Text(
          extent={{-138,270},{-36,256}},
          lineColor={0,0,127},
          textString="to stage 1 which only has boiler 1.")}));
