...
equation
  ...
  connect(tim.passed, booRep2.u) annotation (Line(points={{-78,-118},{-50,-118},
          {-50,-110},{-22,-110}}, color={255,0,255}));
  connect(tim.passed, not1.u) annotation (Line(points={{-78,-118},{-50,-118},{-50,
          -70},{-22,-70}}, color={255,0,255}));
  connect(tim.passed, logSwi4.u3) annotation (Line(points={{-78,-118},{-50,-118},
          {-50,-178},{118,-178}}, color={255,0,255}));
annotation (
