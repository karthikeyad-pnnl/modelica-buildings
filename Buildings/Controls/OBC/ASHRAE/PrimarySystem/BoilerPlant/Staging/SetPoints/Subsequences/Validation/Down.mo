...
model Down
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.SetPoints.Subsequences.Down
    ...
    final nSta=1,
    final minFirPer=1.3,
    final delayMinFir=300,
    final desCapPer=0.8,
    final delayDesCapNonConBoi=600,
    final delayDesCapConBoi=300,
    final sigDif=0.01,
    final dFloRatLow=0,
    final dFloRatHig=0.1,
    final bypValClo=0,
    final TCirDif=3,
    final delayTRetDif=300,
    final dTemp=0.1,
    final TDifFaiCon=10,
...
equation
  ...
  connect(pul1.y, staDow.uQReq) annotation (Line(points={{-148,100},{-130,100},{
          -130,5},{-122,5}}, color={0,0,127}));
  connect(con2.y, staDow.uQMin) annotation (Line(points={{-148,60},{-132,60},{-132,
          3},{-122,3}}, color={0,0,127}));
  connect(pul3.y, staDow.uPriCirFloRat) annotation (Line(points={{-174,0},{-136,
          0},{-136,-3},{-122,-3}}, color={0,0,127}));
  connect(con4.y, staDow.uMinPriPumFlo) annotation (Line(points={{-148,-26},{-136,
  ...
  connect(conInt.y, staDow.uTyp) annotation (Line(points={{-148,-140},{-120,-140},
          {-120,-12},{-119,-12}}, color={255,127,0}));
  connect(conInt1.y, staDow.uAvaDow) annotation (Line(points={{-148,-180},{-116,
          -180},{-116,-12},{-117,-12}}, color={255,127,0}));
  ...
  connect(pul5.y, staDow1.uQReq) annotation (Line(points={{-8,100},{10,100},{10,
          5},{18,5}}, color={0,0,127}));
  connect(con7.y, staDow1.uQMin)
    annotation (Line(points={{-8,60},{8,60},{8,3},{18,3}}, color={0,0,127}));
  connect(pul7.y, staDow1.uPriCirFloRat)
    annotation (Line(points={{-34,0},{4,0},{4,-3},{18,-3}}, color={0,0,127}));
  connect(con9.y, staDow1.uMinPriPumFlo) annotation (Line(points={{-8,-26},{4,-26},
  ...
  connect(conInt2.y, staDow1.uTyp) annotation (Line(points={{-8,-140},{20,-140},
          {20,-12},{21,-12}}, color={255,127,0}));
  connect(conInt3.y, staDow1.uAvaDow) annotation (Line(points={{-8,-180},{24,-180},
          {24,-12},{23,-12}}, color={255,127,0}));
  ...
  connect(pul9.y, staDow2.uQReq) annotation (Line(points={{132,100},{150,100},{150,
          5},{158,5}}, color={0,0,127}));
  connect(conInt4.y, staDow2.uTyp) annotation (Line(points={{132,-140},{160,-140},
          {160,-12},{161,-12}}, color={255,127,0}));
  connect(conInt5.y, staDow2.uAvaDow) annotation (Line(points={{132,-180},{164,-180},
          {164,-12},{163,-12}}, color={255,127,0}));
  connect(pul11.y, staDow2.uBypValPos) annotation (Line(points={{106,0},{132,0},
          {132,1},{158,1}}, color={0,0,127}));
  connect(pul10.y, staDow.uQDowDes) annotation (Line(points={{-148,30},{-134,30},
          {-134,-1},{-122,-1}}, color={0,0,127}));
  connect(pul12.y, staDow1.uQDowDes)
    annotation (Line(points={{-8,30},{6,30},{6,-1},{18,-1}}, color={0,0,127}));
  connect(pul13.y, staDow2.uQDowDes) annotation (Line(points={{132,-40},{146,-40},
          {146,-1},{158,-1}}, color={0,0,127}));
  connect(con13.y, staDow2.uQMin) annotation (Line(points={{132,60},{146,60},{146,
          3},{158,3}}, color={0,0,127}));
annotation (
  experiment(
      StopTime=16000,
      Interval=1,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/BoilerPlant/Staging/Subsequences/Validation/Down.mos"
    "Simulate and plot"),
  Documentation(info="<html>
    <p>
    This example validates
    <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.Subsequences.Down\">
    Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.Subsequences.Down</a>.
    </p>
    </html>", revisions="<html>
    <ul>
    <li>
