...
equation
  ...
  connect(cap.y, yDes) annotation (Line(points={{-78,150},{66,150},{66,150},{
          220,150}}, color={0,0,127}));
  connect(swi2.y, yUpDes) annotation (Line(points={{122,60},{168,60},{168,60},{
          220,60}}, color={0,0,127}));
  connect(swi1.y, yDowDes)
    annotation (Line(points={{122,20},{220,20}}, color={0,0,127}));
  connect(swi4.y, yUpMin) annotation (Line(points={{124,-90},{168,-90},{168,-90},
          {220,-90}}, color={0,0,127}));
  connect(capMin.y, yMin) annotation (Line(points={{22,-70},{100,-70},{100,-20},
