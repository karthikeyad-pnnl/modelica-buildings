...
model SetpointController_baseline
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.SetPoints.SetpointController_baseline staSetCon1(
    final have_priOnl=false,
    final nBoi=2,
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Staging.SetPoints.SetpointController_baseline staSetCon2(
...
equation
  connect(staSetCon.yChaEdg, staCha.u) annotation (Line(points={{82,156},{90,156},
  ...
  connect(staUp.u, staSetCon.yChaUpEdg) annotation (Line(points={{98,190},{90,190},
          {90,160},{82,160}}, color={255,0,255}));
  connect(staDow.u, staSetCon.yChaDowEdg) annotation (Line(points={{98,130},{94,
          130},{94,152},{82,152}}, color={255,0,255}));
  connect(staSetCon1.ySta, intToRea1.u)
    annotation (Line(points={{82,-76},{94,-76},{94,-82},{98,-82}},
                                                 color={255,127,0}));
  ...
  connect(staSetCon1.yChaEdg, staCha1.u) annotation (Line(points={{82,-84},{90,-84},
  ...
  connect(staUp1.u, staSetCon1.yChaUpEdg) annotation (Line(points={{98,-50},{90,
          -50},{90,-80},{82,-80}}, color={255,0,255}));
  connect(staDow1.u, staSetCon1.yChaDowEdg) annotation (Line(points={{98,-110},{
          94,-110},{94,-88},{82,-88}}, color={255,0,255}));
  connect(staSetCon2.ySta, intToRea2.u)
    annotation (Line(points={{482,164},{494,164},{494,158},{498,158}},
                                                   color={255,127,0}));
  ...
  connect(staSetCon2.yChaEdg, staCha2.u) annotation (Line(points={{482,156},{490,
          156},{490,70},{498,70}}, color={255,0,255}));
  ...
  connect(staUp2.u, staSetCon2.yChaUpEdg) annotation (Line(points={{498,190},{490,
          190},{490,160},{482,160}}, color={255,0,255}));
  connect(staDow2.u, staSetCon2.yChaDowEdg) annotation (Line(points={{498,130},{
          494,130},{494,152},{482,152}}, color={255,0,255}));
