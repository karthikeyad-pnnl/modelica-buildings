...
block SetpointController "Calculates the chiller stage status setpoint signal"
  ...
  ChillerPlant.Staging.Subsequences.Change cha(final nSta=nSta, final
      delayStaCha=delayStaCha) "Stage change assignment"
    annotation (Placement(transformation(extent={{-20,-180},{0,-160}})));
  ChillerPlant.Staging.Subsequences.ChillerIndices chiInd(
    nSta=nSta,
    nChi=nChi,
    staMat=staMat)
