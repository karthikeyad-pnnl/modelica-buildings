...
equation
  ...
  connect(cha.uAvaUp, sta.yAvaUp) annotation (Line(points={{-22,-169},{-60,-169},
          {-60,-203},{-288,-203}}, color={255,127,0}));
  connect(cha.uAvaDow, sta.yAvaDow) annotation (Line(points={{-22,-172},{-56,
          -172},{-56,-206},{-288,-206}}, color={255,127,0}));
  connect(staUp.yStaUp, cha.uUp) annotation (Line(points={{-118,-104},{-64,-104},
          {-64,-175},{-22,-175}}, color={255,0,255}));
  connect(staDow.yStaDow, cha.uDow) annotation (Line(points={{-118,-240},{-64,
          -240},{-64,-179},{-22,-179}},
                                  color={255,0,255}));
  ...
  connect(conf.yTyp, yStaTyp) annotation (Line(points={{-338,-174},{-336,-174},{
          -336,40},{140,40}}, color={255,127,0}));
  connect(u, sta.u) annotation (Line(points={{-420,-110},{-320,-110},{-320,-204},
          {-312,-204}}, color={255,127,0}));
  connect(u, cap.u) annotation (Line(points={{-420,-110},{-320,-110},{-320,-167},
          {-272,-167}}, color={255,127,0}));
  connect(u, staDow.uCur) annotation (Line(points={{-420,-110},{-320,-110},{
          -320,-228},{-142,-228}}, color={255,127,0}));
  connect(conf.yAva, cha.uStaAva) annotation (Line(points={{-338,-178},{-332,
          -178},{-332,-264},{-26,-264},{-26,-161},{-22,-161}}, color={255,0,255}));
