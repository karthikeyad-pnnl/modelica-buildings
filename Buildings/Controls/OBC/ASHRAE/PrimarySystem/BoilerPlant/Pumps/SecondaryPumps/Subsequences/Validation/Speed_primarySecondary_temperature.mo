...
model Speed_primarySecondary_temperature
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/BoilerPlant/Pumps/PrimaryPumps/Subsequences/Validation/Speed_primarySecondary_temperature.mos"
    "Simulate and plot"),
...
end Speed_primarySecondary_temperature;
