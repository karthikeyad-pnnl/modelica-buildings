...
model Speed_primarySecondary_flow
  "Validate sequence of controlling hot water pump speed for primary-secondary plants with flowrate sensors"

  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Pumps.PrimaryPumps.Subsequences.Speed_primarySecondary_flow
    hotPumSpe(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/BoilerPlant/Pumps/PrimaryPumps/Subsequences/Validation/Speed_primarySecondary_flow.mos"
    "Simulate and plot"),
...
end Speed_primarySecondary_flow;
