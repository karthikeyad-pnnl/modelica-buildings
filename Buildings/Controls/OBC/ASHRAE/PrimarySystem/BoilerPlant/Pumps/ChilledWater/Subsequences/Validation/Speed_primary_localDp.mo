...
model Speed_primary_localDp
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Pumps.ChilledWater.Subsequences.Speed_primary_localDp
    ...
    "Hot water pump speed control based local pressure difference sensor"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/BoilerPlant/Pumps/ChilledWater/Subsequences/Validation/Speed_primary_localDp.mos"
    "Simulate and plot"),
