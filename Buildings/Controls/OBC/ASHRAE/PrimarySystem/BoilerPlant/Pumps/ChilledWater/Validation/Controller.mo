within Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Pumps.ChilledWater.Validation;

model Controller
    "Validate boiler water pump control sequence"

  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Pumps.ChilledWater.Controller
    heaNoLoc(nPum=3, nPum_nominal=3)
    "Pump speed control for plant with headered primary hot water pump and without local DP sensor"
    annotation (Placement(transformation(extent={{40,120},{60,140}})));

  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt[3](k={2,1,3})
    "Hot water pump operating priority"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Pumps.ChilledWater.Controller
    ...
    nPum=3,
    nPum_nominal=3)
    "Pump speed control for plant with dedicated primary hot water pump and without local DP sensor"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Pumps.ChilledWater.Controller
    ...
    nPum=3,
    nPum_nominal=3)
    "Pump speed control for plant with dedicated primary hot water pump and with local DP sensor"
