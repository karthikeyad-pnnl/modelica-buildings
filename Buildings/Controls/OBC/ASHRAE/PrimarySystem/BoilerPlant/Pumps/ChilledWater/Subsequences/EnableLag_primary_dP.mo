...
<p>
Block that enable and disable lag primary hot water pump, for plants
with headered primary hot water pumps, 
according to ASHRAE RP-1711 Advanced Sequences of Operation for HVAC Systems Phase II –
Central Plants and Hydronic Systems (Draft 6 on July 25, 2019), 
section 5.2.6 Primary hot water pumps, part 5.2.6.6.
</p>
<p>
Hot water pump shall be staged as a function of hot water flow ratio (CHWFR), 
i.e. the ratio of current hot water flow <code>VChiWat_flow</code> to design
