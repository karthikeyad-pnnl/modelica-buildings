...
<p>
Block that output hot water pump speed setpoint for primary-only plants where
...
section 5.2.6 Primary hot water pumps, part 5.2.6.7 and 5.2.6.8.
</p>
<ol>
<li>
When any hot water pump is proven on, <code>uChiWatPum</code> = true, 
