...
block EnableLead_dedicated
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uLeaChiWatReq
    "Status indicating if boiler is requesting hot water"
...
section 5.2.6 Primary hot water pumps, part 5.2.6.5.
</p>
<p>
The lead primary hot water pump should be enabled when lead boiler is commanded 
to run (<code>uLeaChiEna</code> = true). It should be disabled when the lead 
boiler is disabled and either the lead boiler has been proven off (<code>uLeaChiSta</code> 
= false) for 3 minutes or is not requesting hot water flow 
