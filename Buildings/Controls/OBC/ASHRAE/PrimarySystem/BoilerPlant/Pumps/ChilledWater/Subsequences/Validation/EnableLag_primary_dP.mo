...
model EnableLag_primary_dP
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Pumps.ChilledWater.Subsequences.EnableLag_primary_dP
    enaLagChiPum(
    final nPum=3, final VChiWat_flow_nominal=0.5)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/BoilerPlant/Pumps/ChilledWater/Subsequences/Validation/EnableLag_primary_dP.mos"
    "Simulate and plot"),
