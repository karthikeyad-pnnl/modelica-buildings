...
model Controller_baseline_OAReset "Boiler plant controller"
...
protected
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.SetPoints.HotWaterSupplyTemperatureReset_OATemp hotWatSupTemRes(
    final nPum=nPumPri,
    final nSta=nSta,
    final nBoi=nBoi,
...
equation
  ...
  connect(TOut, hotWatSupTemRes.TOut) annotation (Line(points={{-420,310},{-380,
          310},{-380,200},{-160,200},{-160,185},{-142,185}}, color={0,0,127}));
...
end Controller_baseline_OAReset;
