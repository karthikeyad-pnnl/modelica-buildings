...
block PumpSpeed
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput IsoValSig_a
    "Signal commanding isolation valve open"
    annotation (Placement(transformation(extent={{-140,80},{-100,120}})));

  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput IsoValSig_b
    "Signal commanding isolation valve open"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uHotWatDifPre
    "Measured differential pressure between supply and return sides in primary circuit"
    annotation (Placement(transformation(extent={{-140,-40},{-100,0}})));

  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uPumProSig_a
    "Signal indicating lead pump is proved on"
    annotation (Placement(transformation(extent={{-140,-80},{-100,-40}})));

  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uPumProSig_b
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput yPumSta_a
    "Pump start signal for lead pump"
    annotation (Placement(transformation(extent={{100,40},{140,80}})));

  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput yPumSta_b
    "Pump start signal for lag pump"
    annotation (Placement(transformation(extent={{100,-20},{140,20}})));

  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yPumSpe
    "Pump speed signal to both pumps"
    annotation (Placement(transformation(extent={{100,-80},{140,-40}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant priCirDesFloRat(k=priCirDesFloRatVal)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Division div
    "Hot water flow ratio calculation"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant pumStaLim(k=0.47)
    "Hot-water flow ratio limit for pump staging"
    annotation (Placement(transformation(extent={{-8,0},{12,20}})));

  Buildings.Controls.OBC.CDL.Logical.Or or1
    "Checking to see if either of the pumps are proved on"
    annotation (Placement(transformation(extent={{-68,-70},{-48,-50}})));

  Buildings.Controls.OBC.CDL.Continuous.LimPID pumSpeCon(
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant hotWatDifPreMax(k=hotWatDifPreMaxVal)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant maxPumSpeSig(k=1)
