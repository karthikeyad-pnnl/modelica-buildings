...
block PumpSpeed
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul(period=5, startTime=1)
    annotation (Placement(transformation(extent={{-92,70},{-72,90}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul1(period=10, startTime=1)
    annotation (Placement(transformation(extent={{-92,40},{-72,60}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul2(period=20, startTime=1)
    annotation (Placement(transformation(extent={{-90,-16},{-70,4}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul3(period=40, startTime=1)
    annotation (Placement(transformation(extent={{-90,-46},{-70,-26}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con1(k=0.8)
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul4(period=5, startTime=1)
    annotation (Placement(transformation(extent={{0,60},{20,80}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul5(period=10, startTime=1)
    annotation (Placement(transformation(extent={{0,30},{20,50}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul6(period=20, startTime=1)
    annotation (Placement(transformation(extent={{2,-26},{22,-6}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul7(period=40, startTime=1)
    annotation (Placement(transformation(extent={{2,-56},{22,-36}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con2(k=0.47*0.01703)
