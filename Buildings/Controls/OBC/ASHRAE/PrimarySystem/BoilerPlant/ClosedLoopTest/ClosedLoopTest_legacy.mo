...
equation
  ...
  connect(controller.yBoi, boilerPlant.uBoiSta)
    annotation (Line(points={{-22.4,5.45455},{16,5.45455},{16,6},{40,6}},
                                                           color={255,0,255}));
  connect(controller.yHotWatIsoVal, boilerPlant.uHotIsoVal)
    annotation (Line(points={{-22.4,1.81818},{16,1.81818},{16,3},{40,3}},
                                                           color={0,0,127}));
  connect(controller.yBypValPos, boilerPlant.uBypValSig)
    annotation (Line(points={{-22.4,-1.81818},{12,-1.81818},{12,-6},{40,-6}},
                                                             color={0,0,127}));
  ...
  connect(reaToInt.y, controller.supResReq) annotation (Line(points={{92,-50},{
          96,-50},{96,-64},{-64,-64},{-64,7.27273},{-40.8,7.27273}},
                                                      color={255,127,0}));
  ...
  connect(con3.y, controller.uBoiAva) annotation (Line(points={{-38,-50},{-30,
          -50},{-30,-30},{-60,-30},{-60,-14.5455},{-40.8,-14.5455}},
                                                              color={255,0,255}));
  ...
  connect(weaBus.TDryBul, controller.TOut) annotation (Line(
      points={{-50,60},{-28,60},{-28,40},{-72,40},{-72,3.63636},{-40.8,3.63636}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(boilerPlant.ySupTem, controller.TSup) annotation (Line(points={{64,4},
          {100,4},{100,-68},{-68,-68},{-68,0},{-40.8,0}}, color={0,0,127}));
  connect(boilerPlant.yRetTem, controller.TRet) annotation (Line(points={{64,0},
          {104,0},{104,-72},{-72,-72},{-72,-3.63636},{-40.8,-3.63636}}, color={
          0,0,127}));
  connect(boilerPlant.VHotWat_flow, controller.VHotWat_flow) annotation (Line(
        points={{64,-8},{112,-8},{112,-80},{-80,-80},{-80,-7.27273},{-40.8,
          -7.27273}}, color={0,0,127}));
  connect(boilerPlant.yHotWatDp, controller.dpHotWat_remote) annotation (Line(
        points={{64,-4},{108,-4},{108,-76},{-76,-76},{-76,-10.9091},{-40.8,
          -10.9091}}, color={0,0,127}));
  connect(controller.yPum, boilerPlant.uPumSta) annotation (Line(points={{-22.4,
          -5.45455},{0,-5.45455},{0,0},{40,0}}, color={255,0,255}));
  connect(controller.yPumSpe, boilerPlant.uPumSpe) annotation (Line(points={{
          -22.4,-9.09091},{4,-9.09091},{4,-3},{40,-3}}, color={0,0,127}));
