...
block PlantDisable
  ...
  CDL.Logical.MultiOr mulOr(nu=nBoi) "Multi Or"
...
equation
  ...
  connect(booRep.y, triSam.trigger) annotation (Line(points={{-38,90},{10,90},{10,
          34},{-10,34},{-10,38.2}}, color={255,0,255}));
  connect(lat.y, booRep1.u)
    annotation (Line(points={{-58,120},{-42,120}}, color={255,0,255}));
  connect(booRep1.y, logSwi.u2) annotation (Line(points={{-18,120},{0,120},{0,100},
          {110,100},{110,50},{118,50}},
                         color={255,0,255}));
  connect(uBoi, logSwi.u1) annotation (Line(points={{-180,50},{-140,50},{-140,30},
          {100,30},{100,58},{118,58}}, color={255,0,255}));
  connect(booRep1.y, logSwi.u3) annotation (Line(points={{-18,120},{0,120},{0,100},
          {110,100},{110,42},{118,42}},
                         color={255,0,255}));
  connect(logSwi.y, yBoi)
    annotation (Line(points={{142,50},{200,50}}, color={255,0,255}));
  ...
  connect(reaRep.y, disHotWatIsoVal.uHotWatIsoVal) annotation (Line(points={{-118,
          -50},{10,-50},{10,-45},{38,-45}},    color={0,0,127}));
  connect(reaToInt.y, disHotWatIsoVal.nexChaBoi) annotation (Line(points={{42,50},
          {50,50},{50,20},{30,20},{30,-42},{38,-42}},    color={255,127,0}));
  connect(booRep1.y, not1.u) annotation (Line(points={{-18,120},{0,120},{0,100},
          {110,100},{110,10},{-150,10},{-150,-10},{-142,-10}},
                                            color={255,0,255}));
  connect(not1.y, disHotWatIsoVal.chaPro) annotation (Line(points={{-118,-10},{-110,
          -10},{-110,-58},{38,-58}},  color={255,0,255}));
  ...
  connect(booRep2.y, disHotWatIsoVal.uUpsDevSta) annotation (Line(points={{2,-10},
          {20,-10},{20,-55},{38,-55}}, color={255,0,255}));
  ...
  connect(disHotWatIsoVal.yHotWatIsoVal, extIndSig.u) annotation (Line(points={{
          62,-56},{70,-56},{70,-50},{78,-50}}, color={0,0,127}));
  connect(conInt.y, extIndSig.index) annotation (Line(points={{-128,70},{-126,70},
          {-126,20},{20,20},{20,0},{74,0},{74,-70},{90,-70},{90,-62}}, color={255,
          127,0}));
  connect(and2.y, or2.u2) annotation (Line(points={{42,-120},{60,-120},{60,-128},
          {118,-128}}, color={255,0,255}));
  connect(disHotWatIsoVal.yEnaHotWatIsoVal, mulAnd1.u[1:nBoi]) annotation (Line(
        points={{62,-44},{66,-44},{66,-116},{78,-116}},           color={255,0,255}));
  connect(mulAnd1.y, or2.u1) annotation (Line(points={{102,-116},{110,-116},{110,
          -120},{118,-120}}, color={255,0,255}));
  connect(uStaChaPro, and2.u1)
    annotation (Line(points={{-180,-120},{18,-120}}, color={255,0,255}));
  connect(booRep1.y, mulOr.u[1:nBoi]) annotation (Line(points={{-18,120},{0,120},
          {0,100},{110,100},{110,-66},{-50,-66},{-50,-100},{-42,-100}},
                                                      color={255,0,255}));
  connect(mulOr.y, and2.u2) annotation (Line(points={{-18,-100},{0,-100},{0,-128},
  ...
  connect(disHotWatIsoVal.yEnaHotWatIsoVal, mulAnd2.u[1:nBoi]) annotation (Line(
        points={{62,-44},{66,-44},{66,-90},{78,-90}}, color={255,0,255}));
  connect(lat1.y, mulOr1.u[1]) annotation (Line(points={{-78,-80},{0,-80},{0,
          -90},{18,-90}}, color={255,0,255}));
  connect(mulOr1.y, or2.u1) annotation (Line(points={{42,-90},{48,-90},{48,-136},
