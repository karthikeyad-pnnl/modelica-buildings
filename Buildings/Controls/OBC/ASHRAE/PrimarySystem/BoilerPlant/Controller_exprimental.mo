...
model Controller_exprimental "Boiler plant controller"
  ...
  CDL.Continuous.Sources.Constant zerOrdHol2[nBoi](k=fill(0, nBoi))
    "Zero order hold"
  ...
  CDL.Integers.Sources.Constant conInt3(k=1)
    annotation (Placement(transformation(extent={{-150,170},{-130,190}})));
  CDL.Integers.Sources.Constant conInt4(k=1)
...
equation
  ...
  connect(pre5.y, dowProCon.uBoi) annotation (Line(points={{192,180},{200,180},{
          ...
          255,0,255}));
  connect(zerOrdHol2.y, dowProCon.uHotWatIsoVal) annotation (Line(points={{282,30},
          {290,30},{290,12},{102,12},{102,46},{118,46}},     color={0,0,127}));
  connect(zerOrdHol2.y, upProCon.uHotWatIsoVal) annotation (Line(points={{282,30},
          {290,30},{290,12},{102,12},{102,102},{118,102}},     color={0,0,127}));
  connect(zerOrdHol2.y, priPumCon.uHotIsoVal) annotation (Line(points={{282,30},
          {290,30},{290,12},{102,12},{102,-122},{118,-122}}, color={0,0,127}));
  ...
  connect(conInt3.y, intToRea1.u)
    annotation (Line(points={{-128,180},{-112,180}}, color={255,127,0}));
  connect(conInt4.y, intToRea2.u)
    annotation (Line(points={{2,220},{18,220}}, color={255,127,0}));
  connect(intToRea1.y, reaToInt1.u)
    annotation (Line(points={{-88,180},{-52,180}}, color={0,0,127}));
  connect(intToRea2.y, reaToInt2.u)
