...
model Controller_experimental
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.BoilerPlant.Controller_exprimental controller_highDelays(primaryOnly=true,
    nBoi=2,
    ...
    annotation (Placement(transformation(extent={{20,-72},{62,-28}})));
equation
  connect(conInt.y, controller_highDelays.supResReq) annotation (Line(points={{-38,
          70},{-8,70},{-8,-42},{18,-42}}, color={255,127,0}));
  connect(con.y, controller_highDelays.TOut) annotation (Line(points={{-38,40},{
          -12,40},{-12,-46},{18,-46}}, color={0,0,127}));
  connect(con1.y, controller_highDelays.TSup) annotation (Line(points={{-38,10},
          {-16,10},{-16,-50},{18,-50}}, color={0,0,127}));
  connect(con2.y, controller_highDelays.TRet) annotation (Line(points={{-38,-20},
          {-32,-20},{-32,-54},{18,-54}}, color={0,0,127}));
  connect(con3.y, controller_highDelays.VHotWat_flow) annotation (Line(points={{
          -38,-50},{-26,-50},{-26,-58},{18,-58}}, color={0,0,127}));
  connect(con4.y, controller_highDelays.dpHotWat_remote) annotation (Line(
        points={{-38,-80},{-20,-80},{-20,-62},{18,-62}}, color={0,0,127}));
  annotation (
