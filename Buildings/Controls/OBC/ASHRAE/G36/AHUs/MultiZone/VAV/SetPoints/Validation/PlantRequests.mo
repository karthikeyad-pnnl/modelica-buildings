...
model PlantRequests
  ...
  Buildings.Controls.OBC.CDL.Examples.Task4 plaReq
    "Calculate plant request"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  Buildings.Controls.OBC.CDL.Examples.Task4 plaReq1
    "Calculate plant request"
...
equation
  ...
  connect(cooCoi.y, plaReq1.uCooCoi) annotation (Line(points={{-58,-80},{20,
