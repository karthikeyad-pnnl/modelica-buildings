...
block PlantRequests "Output plant requests for multizone air handling unit"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerOutput yChiWatResReq if
       cooCoi == Buildings.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
    "Chilled water reset request"
    annotation (Placement(transformation(extent={{200,180},{240,220}}),
        iconTransformation(extent={{100,60},{140,100}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerOutput yChiPlaReq if
       cooCoi == Buildings.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Switch chiWatRes3 if
       cooCoi == Buildings.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
    "Send 3 chilled water reset request"
    annotation (Placement(transformation(extent={{160,190},{180,210}})));
  Buildings.Controls.OBC.CDL.Integers.Switch chiWatRes2 if
       cooCoi == Buildings.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Logical.Latch lat if
       cooCoi == Buildings.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
    "Keep true signal until other condition becomes true"
    annotation (Placement(transformation(extent={{-40,90},{-20,110}})));
  Buildings.Controls.OBC.CDL.Integers.Switch chiWatRes1 if
       cooCoi == Buildings.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Logical.Latch lat1 if
       cooCoi == Buildings.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
    "Keep true signal until other condition becomes true"
  ...
  Buildings.Controls.OBC.CDL.Reals.Subtract heaSupTemDif if
       heaCoi==Buildings.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Integers.Switch hotWatRes3 if
       heaCoi==Buildings.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Send 3 hot water reset request"
    annotation (Placement(transformation(extent={{160,-50},{180,-30}})));
  Buildings.Controls.OBC.CDL.Integers.Switch hotWatRes2 if
       heaCoi==Buildings.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Logical.Latch lat2 if
       heaCoi==Buildings.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Keep true signal until other condition becomes true"
    annotation (Placement(transformation(extent={{-40,-150},{-20,-130}})));
  Buildings.Controls.OBC.CDL.Integers.Switch hotWatRes1 if
       heaCoi==Buildings.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Logical.Latch lat3 if
       heaCoi==Buildings.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Keep true signal until other condition becomes true"
    annotation (Placement(transformation(extent={{-40,-230},{-20,-210}})));
  Buildings.Controls.OBC.CDL.Integers.Switch intSwi1 if
       heaCoi==Buildings.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
