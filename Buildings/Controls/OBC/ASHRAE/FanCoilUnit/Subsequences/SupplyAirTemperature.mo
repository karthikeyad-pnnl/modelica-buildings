...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Product mul
  ...
  Buildings.Controls.OBC.CDL.Continuous.Product mul1
  ...
  Buildings.Controls.OBC.CDL.Continuous.Product mul2
    "Output heating coil signal only when fan is proven on"
    annotation (Placement(transformation(extent={{90,50},{110,70}})));

  Buildings.Controls.OBC.CDL.Continuous.Product mul3
