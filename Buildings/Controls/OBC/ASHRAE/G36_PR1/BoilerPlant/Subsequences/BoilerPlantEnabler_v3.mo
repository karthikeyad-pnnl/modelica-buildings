...
model BoilerPlantEnabler_v3
  ...
  CDL.Logical.Or or4
    annotation (Placement(transformation(extent={{112,-114},{126,-100}})));
...
equation
  ...
  connect(or4.u2, or2.u2) annotation (Line(points={{110.6,-112.6},{92,-112.6},{
          92,-114},{-40,-114},{-40,-102},{-36,-102}}, color={255,0,255}));
  connect(greEqu2.y, or3.u2) annotation (Line(points={{92,-102},{102,-102},{102,
          -52.4},{112.4,-52.4}}, color={255,0,255}));
  connect(or3.y, or4.u1) annotation (Line(points={{131.6,-46},{138,-46},{138,
          -98},{108,-98},{108,-106},{110.6,-106},{110.6,-107}}, color={255,0,
          255}));
  connect(or4.y, lat.clr) annotation (Line(points={{127.4,-107},{130,-107},{130,
          -62},{56,-62},{56,-78},{-6,-78},{-6,-70},{-2,-70}}, color={255,0,255}));
  connect(or5.u2, or4.u1) annotation (Line(points={{84.8,-54.8},{82,-54.8},{82,
          -60},{132,-60},{132,-48},{138,-48},{138,-98},{108,-98},{108,-106},{
          110.6,-106},{110.6,-107}}, color={255,0,255}));
  connect(or5.u1, or1.u2) annotation (Line(points={{84.8,-50},{78,-50},{78,-66},
          {52,-66},{52,-76},{-42,-76},{-42,-72},{-36,-72}}, color={255,0,255}));
  connect(or5.y, lat1.clr) annotation (Line(points={{99.2,-50},{104,-50},{104,
          -118},{-6,-118},{-6,-100},{-2,-100}}, color={255,0,255}));
