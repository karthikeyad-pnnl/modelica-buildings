...
model PumpSpeed
  .Buildings.Controls.OBC.ASHRAE.G36_PR1.BoilerPlant.SetPoints.PumpSpeed pumpSpeed
  ...
  CDL.Continuous.Sources.Constant con1(k=1.1)
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.BoilerPlant.SetPoints.PumpSpeed pumpSpeed1
