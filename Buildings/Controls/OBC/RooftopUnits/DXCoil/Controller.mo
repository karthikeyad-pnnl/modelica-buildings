...
equation
  ...
  connect(or2.y, chaSta1.uLasDXCoiSta) annotation (Line(points={{62,30},{100,30},
          {100,94},{128,94}}, color={255,0,255}));
  connect(and2.y, chaSta1.uNexDXCoiSta)
    annotation (Line(points={{62,90},{96,90},{96,98},{128,98}},
                                               color={255,0,255}));
  connect(chaSta1.yDXCoi, logSwi.u1) annotation (Line(points={{152,90},{160,90},
  ...
  connect(reaToInt1.y, chaSta1.uNexDXCoi) annotation (Line(points={{102,0},{110,
          0},{110,86},{128,86}},  color={255,127,0}));
