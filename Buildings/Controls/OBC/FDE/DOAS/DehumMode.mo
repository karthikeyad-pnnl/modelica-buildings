...
equation
  connect(retHum, gre.u1) annotation (
   Line(points={{-122,0},{-46,0}}, color={0,0,127}));
   
  connect(retHum, les.u1) annotation (
   Line(points={{-122,0},{-56,0},{-56,-32},{-46,-32}}, color={0,0,127}));
   
  connect(conDset.y, les.u2) annotation (
   Line(points={{-66,-40},{-46,-40}}, color={0,0,127}));
   
  connect(conDset.y, gre.u2) annotation (
   Line(points={{-66,-40},{-60,-40},{-60,-8},{-46,-8}}, color={0,0,127}));
   
  connect(les.y, truDel.u) annotation (
   Line(points={{-22,-32},{-16,-32}}, color={255,0,255}));
    
  connect(truDel.y, lat.clr) annotation (
   Line(points={{8,-32},{14,-32},{14,-6},{20,-6}}, color={255,0,255}));
    
  connect(lat.y, and2.u2) annotation (
   Line(points={{44,0},{56,0}}, color={255,0,255}));
   
  connect(dehumMode, dehumMode) annotation (
   Line(points={{122,8},{122,8}}, color={255,0,255}));
   
  connect(and2.y, dehumMode) annotation (
   Line(points={{80,8},{122,8}}, color={255,0,255}));
   
  connect(supFanProof, minimumRun.u) annotation (
   Line(points={{-122,38},{-46,38}}, color={255,0,255}));
   
  connect(minimumRun.y, and2.u1) annotation (
   Line(points={{-22,38},{48,38},{48,8},{56,8}}, color={255,0,255}));
   
  connect(gre.y, init_delay.u) annotation (
    Line(points={{-22,0},{-16,0}}, color={255,0,255}));
...
FillPattern.Solid),Rectangle(extent={{4,-2},{8,-64}},lineColor={244,125,35},fillColor={244,125,35},
            fillPattern = 
FillPattern.Solid),Text(extent={{-2,42},{36,30}},lineColor={28,108,200},textString="On"),Text(extent={{-2,-38},{36,-50}},lineColor={28,108,200},textString="Off"),Text(extent={{-36,4},{2,-8}},lineColor={28,108,200},textString="%dehumSet"),Text(extent={{-96,80},{-52,66}},lineColor={28,108,200},textString="supFanProof")}),
