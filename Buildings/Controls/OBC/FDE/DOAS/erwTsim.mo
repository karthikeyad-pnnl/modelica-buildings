...
equation
  ...
  connect(sub1.u2, oaT) annotation (
    Line(points={{-90,-38},{-96,-38},{-96,-58},{-122,-58}},color={0,0,127}));
    
  connect(sub1.y, abs.u) annotation (
    Line(points={{-66,-32},{-52,-32}}, color={0,0,127}));
    
  connect(abs.absdiff, pro.u1) annotation (
    Line(points={{-28,-32},{-20,-32}}, color={0,0,127}));
  ...
  connect(reaToInt.y, intEqu.u1)annotation (
   Line(points={{-28,50},{-20,50}}, color={255,127,0}));
  ...
  connect(or3.y, swi.u2)annotation (
  ...
  connect(oaT, add1.u2) annotation (
    Line(points={{-122,-58},{-58,-58},{-58,-74},{8,-74}}, color={0,0,127}));
  
  connect(oaT, sub2.u1) annotation (
    Line(points={{-122,-58},{-58,-58},{-58,-88},{8,-88}}, color={0,0,127}));
    
  connect(add1.y, swi1.u1) annotation (
  Line(points={{32,-68},{42,-68}}, color={0,0,127}));
  
  connect(sub2.y, swi1.u3) annotation (
    Line(points={{32,-94},{38,-94},{38,-84},{42,-84}}, color={0,0,127}));
    
  connect(greThr.y, swi1.u2) annotation (
    Line(points={{-28,-4},{34,-4},{34,-76},{42,-76}}, color={255,0,255}));
    
  connect(swi1.y, swi.u3) annotation (
    Line(points={{66,-76},{70,-76},{70,58},{74,58}}, color={0,0,127}));
