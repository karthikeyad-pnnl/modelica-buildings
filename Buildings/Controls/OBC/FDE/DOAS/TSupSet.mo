...
equation
  connect(lin.u, highSpaceT) annotation(
  Line(points={{-44,2},{-122,2}}, color={0,0,127}));
  
  connect(heatAdj.y, add1.u2) annotation(
    Line(points={{8,-56},{14,-56},{14,-46},{20,-46}},color={0,0,127}));
    
  connect(coolAdj.y, add2.u1) annotation ( Line(points={{8,54},{14,54},{14,42},{20,42}}, color={0,0,127}));
      
  connect(lin.y, add2.u2) annotation (
    Line(points={{-20,2},{2,2},{2,30},{20,30}}, color={0,0,127}));
    
  connect(lin.y, add1.u1) annotation (
    Line(points={{-20,2},{2,2},{2,-34},{20,-34}},
        color={0,0,127}));
        
  connect(add1.y, dehumSwi.u3) annotation(
  Line(points={{44,-40},{64,-40}}, color={0,0,127}));
    
  connect(add2.y, supCooSP) annotation(
    Line(points={{44,36},{122,36}}, color={0,0,127}));
    
  connect(dehumSwi.y, supHeaSP) annotation (
    Line(points={{88,-32},{122,-32}}, color={0,0,127}));
    
  connect(add2.y, dehumSwi.u1) annotation (
  Line(points={{44,36},{54,36},{54,-24},{64,-24}},
      color={0,0,127}));
      
  connect(dehumSwi.u2, dehumMode)annotation (
    Line(points={{64,-32},{54,-32},{54,-82},{-122,-82}},
      color={255,0,255}));
      
  connect(highZoneT.y, lin.x2) annotation (
    Line(points={{-68,-18},{-58,-18},{-58,-2},{-44,-2}},
      color={0,0,127}));
      
  connect(lowZoneT.y, lin.x1)annotation (
    Line(points={{-68,52},{-52,52},{-52,10},{-44,10}},color={0,0,127}));
      
  connect(highPriT.y, lin.f1)annotation (
    Line(points={{-68,20},{-56,20},{-56,6},{-44,6}},
      color={0,0,127}));
      
  connect(lowPriT.y, lin.f2) annotation (
    Line(points={{-68,-50},{-52,-50},{-52,-6},{-44,-6}},color={0,0,127}));
    
  connect(lin.y, supPrimSP)annotation (
    Line(points={{-20,2},{122,2}}, color={0,0,127}));
