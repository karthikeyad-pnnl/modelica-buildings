...
// Line(points={{-62,68},{-56,68},{-56,36.4},{55.8,36.4}},color={255,0,255}));
  ...
  connect(Cooling.TAirEneRecWhe, erwT) annotation (Line(points={{55.8,19.6},{-16,
          19.6},{-16,-216},{-120,-216}}, color={0,0,127}));
  connect(Cooling.yCoiCoo, yCC) annotation (Line(points={{80.2,28},{92,28},{92,
