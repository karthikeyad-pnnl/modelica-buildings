...
block DOAScontroller "DOAS controller built from DOAS blocks."
  ...
  "Set true when unit serves variable volume system." annotation(Dialog(tab = "DOAS", group = "General"));
  ...
  annotation(Placement(transformation(extent = {{-142, 56}, {-102, 96}}), iconTransformation(extent = {{-140, 76}, {-100, 116}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.RealInput mostOpenDam 
  "Most open damper position from all terminal units served." 
  annotation(Placement(transformation(extent = {{-142, 30}, {-102, 70}}), iconTransformation(extent = {{-140, 52}, {-100, 92}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput supFanStatus 
  "True when supply fan is proven on." 
  annotation(Placement(transformation(extent = {{-140, 4}, {-100, 44}}), iconTransformation(extent = {{-140, 28}, {-100, 68}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.RealInput DDSP(
  final unit = "Pa",
  final quantity = "PressureDifference")
  "Down duct static pressure measurement." 
  annotation(Placement(transformation(extent = {{-140, -22}, {-100, 18}}), iconTransformation(extent = {{-140, 4}, {-100, 44}})));
  ...
  annotation(Placement(transformation(extent = {{-140, -80}, {-100, -40}}), iconTransformation(extent = {{-140, -20}, {-100, 20}})));
  ...
  annotation(Placement(transformation(extent = {{-140, -106}, {-100, -66}}), iconTransformation(extent = {{-140, -72}, {-100, -32}})));
  ...
  annotation(Placement(transformation(extent = {{-140, -184}, {-100, -144}}), iconTransformation(extent = {{-140, -146}, {-100, -106}})));
  ...
  annotation(Placement(transformation(extent = {{-140, -210}, {-100, -170}}), iconTransformation(extent = {{-140, -172}, {-100, -132}})));
  ...
  annotation(Placement(transformation(extent = {{-140, -158}, {-100, -118}}), iconTransformation(extent = {{-140, -122}, {-100, -82}})));
  ...
  annotation(Placement(transformation(extent = {{-140, -132}, {-100, -92}}), iconTransformation(extent = {{-140, -96}, {-100, -56}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput exhFanProof
  "True when exhaust fan is proven on." 
  annotation(Placement(transformation(extent = {{-140, -262}, {-100, -222}}), iconTransformation(extent = {{-140, -220}, {-100, -180}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.RealInput bldgSP(
  final unit = "Pa", 
  final quantity = "PressureDifference") 
  "Building static pressure" 
  annotation(Placement(transformation(extent = {{-140, -290}, {-100, -250}}), iconTransformation(extent = {{-140, -244}, {-100, -204}})));
  ...
  annotation(Placement(transformation(extent = {{-140, -50}, {-100, -10}}), iconTransformation(extent = {{-140, -46}, {-100, -6}})));
  
  // ---outputs---
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput supFanStart 
  "Command supply fan to start when true." 
  annotation(Placement(transformation(extent = {{102, 54}, {142, 94}}), iconTransformation(extent = {{102, 34}, {142, 74}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput supFanSpeed 
  "Supply fan speed command" 
  annotation(Placement(transformation(extent = {{102, 28}, {142, 68}}), iconTransformation(extent = {{102, 2}, {142, 42}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yCC 
  "Cooling coil control signal" 
  annotation(Placement(transformation(extent = {{102, 2}, {142, 42}}), iconTransformation(extent = {{102, -30}, {142, 10}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yRHC 
  "Reheat coil valve command." 
  annotation(Placement(transformation(extent = {{102, -24}, {142, 16}}), iconTransformation(extent = {{102, -60}, {142, -20}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput bypDam 
  "Bypass damper command; true when commanded full open." 
  annotation(Placement(transformation(extent = {{102, -50}, {142, -10}}), iconTransformation(extent = {{102, -90}, {142, -50}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput erwStart
   "Command to start the energy recovery wheel." 
   annotation(Placement(transformation(extent = {{102, -74}, {142, -34}}), iconTransformation(extent = {{102, -120}, {142, -80}})));
   
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput erwSpeed 
  "Energy recovery wheel speed command." 
  annotation(Placement(transformation(extent = {{102, -100}, {142, -60}}), iconTransformation(extent = {{102, -152}, {142, -112}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput exhFanStart 
  "Command exhaust fan to start when true." 
  annotation(Placement(transformation(extent = {{102, -128}, {142, -88}}), iconTransformation(extent = {{102, -184}, {142, -144}})));
  
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput exhFanSpeed 
  "Exhaust fan speed command" 
  annotation(Placement(transformation(extent = {{102, -156}, {142, -116}}), iconTransformation(extent = {{102, -216}, {142, -176}})));
  ...
  annotation(Placement(visible = true, transformation(origin = {2, 0}, extent = {{26, -42}, {46, -22}}, rotation = 0)));
