...
equation
  connect(div.u1, relHum) annotation (
    Line(points={{-64,72},{-122,72}}, color={0,0,127}));
    
  connect(div.u2, con100.y) annotation (
    Line(points={{-64,60},{-68,60},{-68,56},{-70,56}},color={0,0,127}));
    
  connect(div.y, log.u) annotation ( 
    Line(points={{-40,66},{-34,66}}, color={0,0,127}));
  
  connect(con1727.y, pro.u2) annotation ( 
    Line(points={{-40,0},{-36,0},{-36,20},{-32,20}},color={0,0,127}));
    
  connect(con2373.y, add2.u2) annotation (
    Line(points={{-40,-42},{-36,-42},{-36,-30},{-32,-30}},color={0,0,127}));
    
  connect(pro.y, div1.u1) annotation ( 
    Line(points={{-8,26},{-2,26}},  color={0,0,127}));
    
  connect(add2.y, div1.u2) annotation ( 
    Line(points={{-8,-24},{-6,-24},{-6,14},{-2,14}},color={0,0,127}));
    
  connect(div1.y, add1.u2) annotation (
    Line(points={{22,20},{28,20}}, color={0,0,127}));
  
  connect(log.y, add1.u1) annotation (
    Line(points={{-10,66},{24,66},{24,32},{28,32}},color={0,0,127}));
    
  connect(add1.y, div2.u1) annotation ( 
    Line(points={{52,26},{60,26}}, color={0,0,127}));
    
  connect(con1727.y, div2.u2) annotation (
  Line(points={{-40,0},{54,0},{54,14},{60,14}},color={0,0,127}));
  
  connect(div2.y, pro1.u1)
    annotation (Line(points={{84,20},{82,20},{82,-6},{-2,-6},{-2,-30},{2,-30}},color={0,0,127}));
    
  connect(con2373.y, pro1.u2) annotation (
    Line(points={{-40,-42},{2,-42}},  color={0,0,127}));
    
  connect(pro1.y, div3.u1) annotation ( 
    Line(points={{26,-36},{58,-36}}, color={0,0,127}));
    
  connect(div2.y, add3.u2) annotation (
    Line(points={{84,20},{82,20},{82,-6},{-2,-6},{-2,-76},{30,-76}}, color={0,0,127}));
    
  connect(add3.u1, con1.y) annotation (
    Line(points={{30,-64},{28,-64},{28,-62},{26,-62}},color={0,0,127}));
  
  connect(add3.y, div3.u2) annotation (
    Line(points={{54,-70},{56,-70},{56,-48},{58,-48}},color={0,0,127}));
    
  connect(con27315.y, add4.u2) annotation (
  Line(points={{-70,-4},{-70,14},{-98,14},{-98,20},{-94,20}}, color={0,0,127}));
  ...
  connect(div3.y, add5.u1) annotation (
    Line(points={{82,-42},{86,-42},{86,-60},{64,-60},{64,-70},{68,-70}}, color={0,0,127}));
    
  connect(con27315.y, add5.u2) annotation (
    Line(points={{-70,-4},{-70,-68},{-22,-68},{-22,-82},{68,-82}}, color={0,0,127}));
  ...
  annotation (defaultComponentName="Dewpt",
    Icon(coordinateSystem(preserveAspectRatio=false), graphics={Text(extent={{-90,180},{90,76}},lineColor={28,108,200}, textStyle={TextStyle.Bold},textString="%name"),Rectangle(extent={{-100,100},{100,-100}},lineColor={179,151,128},radius=10,fillColor={255,255,255},
            fillPattern =
FillPattern.Solid),Text(extent={{-60,66},{28,-30}},lineColor={28,108,200},fillColor={28,108,200},
          fillPattern = 
FillPattern.Solid,textString="T"),Text(extent={{-28,0},{62,-60}},lineColor={28,108,200},fillColor={28,108,200},
          fillPattern =
FillPattern.Solid,textString="dp"),Text(extent={{-96,74},{-58,46}},lineColor={28,108,200},fillColor={28,108,200},
          fillPattern =
FillPattern.Solid,textString="relHum"),Text(extent={{-96,-50},{-66,-70}},lineColor={28,108,200},fillColor={28,108,200},
          fillPattern =
FillPattern.Solid,textString="dbT"),Text(extent={{64,12},{98,-12}},lineColor={28,108,200},fillColor={28,108,200},
          fillPattern =
FillPattern.Solid,textString="%dpT")}),
