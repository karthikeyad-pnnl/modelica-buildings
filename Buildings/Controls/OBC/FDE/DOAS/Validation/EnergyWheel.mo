...
equation
  ...
  connect(raTGen.y, ERWcon.raT) annotation (
    Line(points={{-40,18},{-4,18},{-4,1.8},{47.8,1.8}}, color={0,0,127}));
  
  connect(oaTGen.y, ERWcon.oaT) annotation (
    Line(points={{-40,-16},{-4,-16},{-4,-1.8},{47.8,-1.8}}, color={0,0,127}));
  
  connect(erwTGen.y, ERWcon.erwT) annotation (
    Line(points={{-40,-48},{0,-48},{0,-4.8},{47.8,-4.8}}, color={0,0,127}));
    
  connect(supPrimGen.y, ERWcon.supPrimSP) annotation (
    Line(points={{-40,-80},{4,-80},{4,-7.8},{47.8,-7.8}}, color={0,0,127}));
