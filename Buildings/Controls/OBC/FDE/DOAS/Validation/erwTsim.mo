...
equation
  connect(oaTGen.y, ERWtemp.oaT) annotation (
    Line(points={{-36,-48},{4,-48},{4,-6},{41.6,-6}}, color={0,0,127}));
    
  connect(raTGen.y, ERWtemp.raT) annotation (
    Line(points={{-36,-14},{0,-14},{0,-2},{41.6,-2}}, color={0,0,127}));
    
  connect(bypDamsim.y, ERWtemp.bypDam) annotation (
    Line(points={{-36,16},{0,16},{0,2},{41.6,2}}, color={255,0,255}));
    
  connect(erwStartgen.y, ERWtemp.erwStart) annotation (
    Line(points={{-36,46},{4,46},{4,6},{41.6,6}}, color={255,0,255}));
