...
equation
  connect(ralHumGen.y, Dewpt.relHum) annotation (
  Line(points={{-26,18},{-16,18},{-16,6},{-6.2,6}}, color={0,0,127}));
  
  connect(raTGen.y, Dewpt.dbT) annotation (
  Line(points={{-26,-20},{-16,-20},{-16,-6},{-6.2,-6}}, color={0,0,127}));
