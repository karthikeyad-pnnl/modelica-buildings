...
equation
  ...
  connect(OccGen.y, SFcon.Occ) annotation (Line(points={{-44,42},{0,42},{0,12},
          {44,12}}, color={255,0,255}));
  connect(mostOpenDamGen.y, SFcon.uDamMaxOpe)
    annotation (Line(points={{-44,8},{44,8}}, color={0,0,127}));
  connect(truDel.y, SFcon.uFanSupPro) annotation (Line(points={{30,-24},{38,-24},
          {38,-10},{36,-10},{36,2},{44,2}}, color={255,0,255}));
  connect(SFcon.yFanSup, truDel.u) annotation (Line(points={{68,10},{68,-66},{6,
          -66},{6,-24}}, color={255,0,255}));
  connect(SFcon.dPAirDucSta, sensorDDSP.y) annotation (Line(points={{44,-2},{44,
          -40},{-36,-40},{-36,-28},{-44,-28}}, color={0,0,127}));
