...
record customPumpCurves_Fairbanks
  "Modified pump data for LargeOffice-Fairbanks"
  extends Generic(
    use_powerCharacteristic=true,
    speed_rpm_nominal=1450,
    power(V_flow={0, 0.144001, 0.288}, P={0, 200, 400}),
    pressure(V_flow={0, 0.144, 0.288}, dp={19000,9500,0}));
  annotation (
...
end customPumpCurves_Fairbanks;
