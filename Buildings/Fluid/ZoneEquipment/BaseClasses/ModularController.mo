...
equation
  ...
  connect(conSupHea.THeaSet, THeaSet) annotation (Line(points={{38,28},{-120,28},
          {-120,20},{-160,20}},       color={0,0,127}));
  connect(TZon, conSupHea.TZon) annotation (Line(points={{-160,94},{-100,94},{
          -100,24},{38,24}},                  color={0,0,127}));
  connect(conSupHea.TOut, TOut) annotation (Line(points={{38,20},{-20,20},{-20,
          -20},{-160,-20}}, color={0,0,127}));
  connect(conSupHea.ySupHea, ySupHea) annotation (Line(points={{62,22},{118,22},
          {118,40},{160,40}},     color={0,0,127}));
  connect(conSupHea.yHeaEna, yHeaEna) annotation (Line(points={{62,18},{120,18},
          {120,80},{160,80}},color={255,0,255}));
  connect(conHeaMod.yEna, conSupHea.uHeaEna) annotation (Line(points={{-58,76},
          {10,76},{10,12},{38,12}},     color={255,0,255}));
  connect(conSupHea.uHeaMod, conHeaMod.yMod) annotation (Line(points={{38,16},{
          20,16},{20,72},{-58,72}},                color={255,0,255}));
