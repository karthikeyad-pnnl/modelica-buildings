...
model PackagedTerminalHeatPump "Package with system model for the packaged terminal heat pump"
  ...
  Buildings.Fluid.HeatExchangers.HeaterCooler_u SupHeaCoi(
    ...
    final m_flow_nominal=mAir_flow_nominal,
    final show_T=true,
    final dp_nominal=dpSupHea_nominal,
    final from_dp=true,
    final energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    final T_start=datCooCoi.sta[1].nomVal.TEvaIn_nominal,
    final Q_flow_nominal=QSup_flow_nominal)
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.AirSource.SingleSpeedHeating HeaCoi(
    redeclare final package Medium = MediumA,
    final show_T=true,
    final dp_nominal=dpHeaDX_nominal,
    final datCoi=datHeaCoi,
    final from_dp=true,
    final energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    final T_start=datCooCoi.sta[1].nomVal.TEvaIn_nominal,
    final datDef=datDef)
...
equation
  ...
  connect(TOut.y, CooCoi.TOut) annotation (Line(points={{-239,-40},{-60,-40},{-60,
