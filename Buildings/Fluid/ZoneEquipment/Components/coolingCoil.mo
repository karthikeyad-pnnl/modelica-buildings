...
model coolingCoil
  ...
  replaceable Buildings.Fluid.ZoneEquipment.Components.coolingCoil_electric coolingCoil_electric1(
  ...
  replaceable Buildings.Fluid.ZoneEquipment.Components.coolingCoil_CCW coolingCoil_CCW1(
    redeclare package MediumA = MediumA,
