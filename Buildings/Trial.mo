within Buildings;
package Trial
  partial model Baseclass_externalInterfaces1
    ...
    Modelica.Fluid.Interfaces.FluidPort_a port_CCW_inlet(redeclare package
        Medium = MediumW) if                                has_coolingCoil and has_coolingCoilCCW
    ...
    Modelica.Fluid.Interfaces.FluidPort_a port_HHW_inlet(redeclare package
        Medium = MediumW) if                                has_heatingCoil and has_heatingCoilHHW
      annotation (Placement(transformation(extent={{-50,-270},{-30,-250}})));

    Modelica.Fluid.Interfaces.FluidPort_a port_OA_inlet(redeclare package
    ...
    annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-220,
          ...
          coordinateSystem(preserveAspectRatio=false, extent={{-220,-260},{220,
              260}})));
  end Baseclass_externalInterfaces1;

  partial model Baseclass_externalInterfaces2
    extends Buildings.Trial.Baseclass_externalInterfaces1;
  ...
  partial model Baseclass_componentInterfaces2
    ...
    Fluid.Sensors.VolumeFlowRate senVolFlo4(redeclare package Medium = MediumW,
      ...
      annotation (Placement(transformation(extent={{-10,-10},{10,10}}, rotation=90,
          origin={80,-180})));
    PowerCalculation powerCalculation if has_coolingCoil and has_coolingCoilCCW
    ...
    Fluid.Sensors.TemperatureTwoPort senTem6(redeclare package Medium = MediumW,
      ...
      annotation (Placement(transformation(extent={{-10,-10},{10,10}}, rotation=270,
          origin={50,-200})));
    PowerCalculation powerCalculation1 if has_heatingCoil and
      has_heatingCoilHHW
  ...
  block trialComponent
    extends Buildings.Trial.Baseclass_componentInterfaces2;
    annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
          coordinateSystem(preserveAspectRatio=false)));
  end trialComponent;
