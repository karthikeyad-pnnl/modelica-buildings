within Buildings.ZoneEquipment.Validation;
block Controller_MultiSpeedCyclingFan_ConstantWaterFlowrate
  extends Modelica.Icons.Example;
  Buildings.ZoneEquipment.Controller_MultiSpeedCyclingFan_ConstantWaterFlowrate
  ...
  Controls.OBC.CDL.Continuous.Sources.Constant con1(k=23)
