...
//protected
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold staCha1(final trueHoldDuration=900, final
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant                        plaSta1(final k=true)
    "Plant status"
    annotation (Placement(transformation(extent={{-160,-200},{-140,-180}})));
  Buildings.Controls.OBC.CDL.Logical.TrueDelay                        truDel1(final delayTime=10,
      final delayOnInit=true) "Delay plant enable signal"
    annotation (Placement(transformation(extent={{-120,-200},{-100,-180}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant                        THotWatSupSet1(final k=
        273.15 + 30) "Hot water supply temperature setpoint"
    annotation (Placement(transformation(extent={{-80,-30},{-60,-10}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant                        zero1(final k=10^(-10))
               "Constant"
    annotation (Placement(transformation(extent={{-160,-130},{-140,-110}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant THotWatSup1(final k=273.15 + 30)
    "Hot water supply temperature"
    annotation (Placement(transformation(extent={{-80,-110},{-60,-90}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant VHotWat_flow1(final k=0.037)
    "Hot water flow rate"
    annotation (Placement(transformation(extent={{-160,-70},{-140,-50}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant THotWatRetSec1(final k=273.15 + 26)
    "Hot water secondary loop return temperature"
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold staUp1(final trueHoldDuration=10, final
      falseHoldDuration=0) "Detect stage up signal"
    annotation (Placement(transformation(extent={{100,-60},{120,-40}})));
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold staDow1(final trueHoldDuration=10, final
      falseHoldDuration=0) "Detect stage down signal"
    annotation (Placement(transformation(extent={{100,-120},{120,-100}})));


  Buildings.Controls.OBC.CDL.Logical.FallingEdge falEdg2 "Falling edge detector"
    annotation (Placement(transformation(extent={{560,60},{580,80}})));
  Buildings.Controls.OBC.CDL.Routing.RealReplicator reaRep2(nout=3) "Convert input into array"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant                        boiAva2
                                                            [2](final k={true,true})
                         "Boiler availability vector"
    annotation (Placement(transformation(extent={{240,10},{260,30}})));
  Buildings.Controls.OBC.CDL.Discrete.ZeroOrderHold                        zerOrdHol2(final
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold staCha2(final trueHoldDuration=900, final
      falseHoldDuration=0) "Detect stage change signal"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant                        plaSta2(final k=true)
    "Plant status"
    annotation (Placement(transformation(extent={{240,40},{260,60}})));
  Buildings.Controls.OBC.CDL.Logical.TrueDelay                        truDel2(final delayTime=10,
      final delayOnInit=true) "Delay plant enable signal"
    annotation (Placement(transformation(extent={{280,40},{300,60}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant                        THotWatSupSet2(final k=
        273.15 + 30) "Hot water supply temperature setpoint"
    annotation (Placement(transformation(extent={{320,202},{340,222}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant                        zero2(final k=10^(-10))
               "Constant"
    annotation (Placement(transformation(extent={{240,110},{260,130}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant THotWatSup2(final k=273.15 + 30)
    "Hot water supply temperature"
    annotation (Placement(transformation(extent={{320,130},{340,150}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant VHotWat_flow2(final k=0.037)
    "Hot water flow rate"
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold staUp2(final trueHoldDuration=10, final
      falseHoldDuration=0) "Detect stage up signal"
    annotation (Placement(transformation(extent={{500,180},{520,200}})));
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold staDow2(final trueHoldDuration=10, final
      falseHoldDuration=0) "Detect stage down signal"
  ...
  Buildings.Controls.OBC.CDL.Routing.RealReplicator reaRep(nout=3) "Convert input into array"
